      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        >
          ...
          <button
            ...
            disabled={adding}
            className="flex items-center gap-1.5 rounded-full px-3.5 py-1.5 text-xs font-semibold transition-colors disabled:opacity-60 bg-primary/10 text-primary hover:bg-primary hover:text-primary-foreground cursor-pointer"
          >
            {adding ? (
