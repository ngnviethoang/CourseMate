...
import { ArrowLeft, Plus, Pencil, Trash2, Loader2, GripVertical, ChevronRight, ChevronDown } from 'lucide-react'
...
export default function CourseDetailPage() {
  ...
  async function saveChapter() {
    ...
    if (!Number.isInteger(chapterForm.sortOrder) || chapterForm.sortOrder < 1) {
      toast.error('Thứ tự chương phải là số nguyên lớn hơn hoặc bằng 1.')
      return
    }
  ...
  async function saveLesson() {
    ...
    if (!Number.isInteger(lessonForm.sortOrder) || lessonForm.sortOrder < 1) {
            ...
            <div className="space-y-1">
              ...
              <Select
                ...
                onValueChange={chapterId => {
                  ...
                  updateLessonForm('chapterId', chapterId)
                  updateLessonForm('courseId', chapter?.courseId ?? id)
                }}
              >
                <SelectTrigger>
