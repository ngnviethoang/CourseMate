...
export default function ContestArenaPage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <p className="text-neutral-400 text-sm leading-relaxed max-w-sm mx-auto">{disqualifiedReason || 'Vi phạm nghiêm trọng nội quy thi.'}</p>
 </div>
 ...
 {antiCheat.lockoutReason || 'Bạn đã vi phạm quy chế thi nhiều lần. Vui lòng đợi hết thời gian phạt để tiếp tục làm bài.'}
 </p>
 ...
 <div
 key={i}
 className="p-6 rounded-3xl bg-amber-500/5 -amber-500/10 space-y-2 group"
 >
