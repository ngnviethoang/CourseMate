  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-500">
        ...
        <Card className="-transparent shadow-2xl shadow-black/5 dark:shadow-black/20 bg-background/60 backdrop-blur-xl">
          ...
          <CardFooter className="flex flex-col items-center shadow-md border-0 border-t-0 border-transparent/10 pt-6 pb-6">
