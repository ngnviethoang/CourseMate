...
internal sealed class GetInstructorLessonsQueryHandler
    : AbstractQueryHandler<GetInstructorLessonsQuery, PagedDto<LessonDto>>
{
    public GetInstructorLessonsQueryHandler(
    ...
    public override async Task<PagedDto<LessonDto>> Handle(
        GetInstructorLessonsQuery request,
        CancellationToken cancellationToken)
    {
        ...
        query = query.WhereIf(
            ...
            x => x.ChapterId == request.ChapterId);
