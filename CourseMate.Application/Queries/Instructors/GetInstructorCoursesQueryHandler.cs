...
public class GetInstructorCoursesQuery : GetListQuery<CourseDto>;

internal sealed class GetInstructorCoursesQueryHandler
    : AbstractQueryHandler<GetInstructorCoursesQuery, PagedDto<CourseDto>>
{
    public GetInstructorCoursesQueryHandler(
    ...
    public override async Task<PagedDto<CourseDto>> Handle(
