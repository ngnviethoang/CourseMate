...
internal sealed class GetInstructorChaptersQueryHandler
    : AbstractQueryHandler<GetInstructorChaptersQuery, PagedDto<ChapterDto>>
{
    public GetInstructorChaptersQueryHandler(
    ...
    public override async Task<PagedDto<ChapterDto>> Handle(
        GetInstructorChaptersQuery request,
