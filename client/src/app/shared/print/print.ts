...
export class Print {
    ...
    public static registrationPrint(ord: string, dataSource: any, customerInfo: any) {
        ...
        total = dataSource.reduce((prev: { toString: () => string; }, curr: {
...
<body onload="window.print();window.close();">
    <div class="header">
        <div class="img"><img alt="" src="assets/images/falinic.png" /></div>
...
`;
    ...
    public static printPrescription(subjectData: any, dataSource: any) {
        ...
        // });
        let svgHtml = parsedHtml.getElementsByClassName('barcode')[0].outerHTML;
        let date = Format.formatDDMMYYYY(new Date());
        let html = `<!doctype html>
<html lang="en">
<head>
    <meta name="viewport" content="width=device-width, initial-scale=1">
...
<body onload="window.print();window.close();">
    ...
    <div class="content-info">
      <div class="flex">
        ...
        <div class="right"><p>Ngày sinh: ${Format.formatDDMMYYYY(subjectData.Birthday)}</p></div>
      </div>
...
`;
    ...
    public static paymentPrintConfigGroup(ord: string, isGroupService: boolean, showPrice: boolean, dataSource: any, customerInfo: any, totalGroup: number) {
        if (parseInt(ord) < 10)
            ord = '0' + ord;
...
`;
    ...
    public static paymentPrintConfig(ord: string, isGroupService: boolean, showPrice: boolean, dataSource: any, customerInfo: any, totalGroup: number) {
        if (parseInt(ord) < 10)
            ord = '0' + ord;
        let displayShowPrice: string = 'block',
            displayShowDetailPrice: string = '',
...
<body onload="window.print();window.close();">
    ...
    <div class="content-info">
      <div class="flex">
        ...
        <div class="right"><p>Ngày sinh: ${Format.formatDDMMYYYY(customerInfo.Birthday)}</p></div>
      </div>
      <p>ĐC: ${customerInfo.Address} </p>
    </div>
    <div class="content-service">
      <h3 class="group-service_name">${groupServiceName}</h3>
        ${dataSource.map((item: { DetailName: any; }, i: number) => `
...
<body onload="window.print();window.close();">
    <div class="header">
        <div class="img"><img alt="" src="assets/images/logo-falinic.png" /></div>
        <div class="info-store">
            <h3>${user.Data.TitleStore}</h3>
            <p>${user.Data.AddressStore}</p>
            <p>ĐT: ${user.Data.PhoneStore}</p>
    ...
    <div class="content-service">
        ${dataSource.map((item: {
            ...
            AmountPaid: any;
            RequestGroupServiceDetailList: any[];
        }, i: number) => `
          <div class="row">
            ...
            ${item.RequestGroupServiceDetailList.map((item1: { GroupDetailName: any; }, i: number) => `
...
`;
    ...
    public static printMedicalRecord(dataSourceService: any, dataSourcePrescription: any, customerInfo: any) {
        let user = LocalStorageConfig.GetUser();
        let html = `<!doctype html>
<html lang="en">
<head>
...
<body onload="window.print();window.close();">
    <div class="header">
        <div class="img"><img alt="" alt="" src="assets/images/falinic.png" /></div>
        <div class="info-store">
            <h3>${user.Data.TitleStore}</h3>
            <p>${user.Data.AddressStore}</p>
            <p>ĐT: ${user.Data.PhoneStore}</p>
  ...
  <div class="content-service">
    ...
    ${dataSourceService.map((item: { DetailName: any; Result: any; }, i: number) => `
          <div class="row">
            <p class="service_name"> ${i + 1}. ${item.DetailName}</p>
...
<div class="content-prescription">
    ...
    ${dataSourcePrescription.map((item: {
            ItemName: any;
            UnitName: any;
            TimeUse: any;
            ItemUsing: any;
...
`;
    ...
    public static printRPLDAccountant(dataSource: any, startDate: any, endDate: any) {
        let user = LocalStorageConfig.GetUser(),
