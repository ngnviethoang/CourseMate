...
import { ExerciseDto, ExerciseService } from '@proxy/catalog-managements/exercises';
import { DifficultyType } from '@proxy/shared';
...
export class RunCodeComponent implements OnInit, OnDestroy {
    ...
    currentExercise: ExerciseDto | null = null;
    ...
    constructor(private router: ActivatedRoute, private exerciseService: ExerciseService, private http: HttpClient) {}
