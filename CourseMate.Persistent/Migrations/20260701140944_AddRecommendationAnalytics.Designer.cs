...
namespace CourseMate.Persistent.Migrations
{
    ...
    [Migration("20260701140944_AddRecommendationAnalytics")]
    partial class AddRecommendationAnalytics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseMate.Persistent.Entities.ContestExercise", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ContestExercises", (string)null);
                });

            modelBuilder.Entity("CourseMate.Persistent.Entities.ContestPrize", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CourseMate.Persistent.Entities.ContestRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ContestRegistrations", (string)null);
                });

            modelBuilder.Entity("CourseMate.Persistent.Entities.ContestSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CourseMate.Persistent.Entities.LessonQuizAnswer", b =>
                {
                    ...
                    b.Property<Guid>("LessonQuizQuestionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LessonQuizQuestionId");

                    b.ToTable("LessonQuizAnswers", (string)null);
                });
            ...
            modelBuilder.Entity("CourseMate.Persistent.Entities.LessonQuizQuestion", b =>
                {
                    ...
                    b.ToTable("LessonQuizQuestions", (string)null);
                });
            ...
            modelBuilder.Entity("CourseMate.Persistent.Entities.RecommendationAnalytics", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<double>("CollaborativeScore")
                        .HasColumnType("double precision");
                    ...
                    b.Property<DateTimeOffset?>("FeedbackTime")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("CourseMate.Persistent.Entities.RecommendationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("StudentId", "RecommendationType");
            ...
            modelBuilder.Entity("CourseMate.Persistent.Entities.StudentPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<string>("FavouriteCategories")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValueSql("'[]'::jsonb");
                    ...
                    b.Property<bool>("RecommendContests")
                        .HasColumnType("boolean");

                    b.Property<bool>("RecommendExercises")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("CourseMate.Persistent.Entities.StudentSkillProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<double>("AverageRuntime")
                        .HasColumnType("double precision");
                    ...
                    b.HasIndex("IsWeakArea");

                    b.HasIndex("StudentId", "Category", "Difficulty")
                        .IsUnique();

                    b.ToTable("StudentSkillProfiles", (string)null);
                });

            modelBuilder.Entity("CourseMate.Persistent.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CourseMate.Persistent.Entities.LessonQuizAnswer", b =>
                {
                    b.HasOne("CourseMate.Persistent.Entities.LessonQuizQuestion", null)
                        .WithMany()
                        .HasForeignKey("LessonQuizQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CourseMate.Persistent.Entities.LessonQuizQuestion", b =>
                {
                    b.HasOne("CourseMate.Persistent.Entities.LessonQuiz", null)
                        .WithMany()
