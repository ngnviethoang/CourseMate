...
\restrict arXUO04lDkOlnkBUmT1nDXqDyVHpvk6G77EqtTmbLg5xA0BlWPe5l9wRUj36tHX
...
CREATE TABLE public."ChatMessages" (
    ...
    "Content" character varying(32768) NOT NULL,
    "SourceChunkIds" character varying(32768),
    "CreationTime" timestamp with time zone NOT NULL,
    "LastModificationTime" timestamp with time zone,
    "UserId" uuid,
    "IsDeleted" boolean NOT NULL
...
--
-- Name: ContestPrizes; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."ContestPrizes" (
    "Id" uuid NOT NULL,
    "ContestId" uuid NOT NULL,
    "CourseId" uuid NOT NULL,
    ...
    "UserId" uuid,
    "IsDeleted" boolean NOT NULL,
    "MaxRank" integer DEFAULT 0 NOT NULL
);


ALTER TABLE public."ContestPrizes" OWNER TO postgres;
...
--
-- Name: CourseCoOccurrences; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."CourseCoOccurrences" (
    "Id" uuid NOT NULL,
    "CourseId" uuid NOT NULL,
    "CoCourseId" uuid NOT NULL,
...
ALTER TABLE public."CourseCoOccurrences" OWNER TO postgres;

--
-- Name: CourseEmbeddings; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."CourseEmbeddings" (
    "Id" uuid NOT NULL,
    "CourseId" uuid NOT NULL,
...
ALTER TABLE public."CourseEmbeddings" OWNER TO postgres;

--
-- Name: CourseSimilarities; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."CourseSimilarities" (
    "Id" uuid NOT NULL,
    "CourseId" uuid NOT NULL,
    "SimilarCourseId" uuid NOT NULL,
    "Score" double precision NOT NULL,
    "CreationTime" timestamp with time zone NOT NULL,
    "LastModificationTime" timestamp with time zone,
    "UserId" uuid,
...
ALTER TABLE public."CourseSimilarities" OWNER TO postgres;
...
--
-- Name: StudentPreferences; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."StudentPreferences" (
    "Id" uuid NOT NULL,
    "StudentId" uuid NOT NULL,
    "FavouriteCategories" jsonb DEFAULT '[]'::jsonb NOT NULL,
    "PreferredDifficulty" integer NOT NULL,
    "LearningGoal" public.citext NOT NULL,
    "MinutesPerDay" integer NOT NULL,
    "SkillLevel" public.citext NOT NULL,
...
ALTER TABLE public."StudentPreferences" OWNER TO postgres;

--
-- Name: StudentSkillProfiles; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."StudentSkillProfiles" (
    "Id" uuid NOT NULL,
    "StudentId" uuid NOT NULL,
...
ALTER TABLE public."StudentSkillProfiles" OWNER TO postgres;
...
--
-- Name: UserRecommendations; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."UserRecommendations" OWNER TO postgres;
...
1	stats:succeeded:2026-07-08-12	1	2026-07-09 12:04:43.713131+00
2	stats:succeeded:2026-07-08	1	2026-08-08 12:04:42.713131+00
...
4	stats:succeeded:2026-07-08	1	2026-08-08 12:05:09.307543+00
5	stats:succeeded:2026-07-08-12	1	2026-07-09 12:05:10.307543+00
...
1	recurring-job:refresh-student-skill-profiles	Queue	default	\N	0
2	recurring-job:refresh-student-skill-profiles	Cron	0 3 * * *	\N	0
3	recurring-job:refresh-student-skill-profiles	TimeZoneId	UTC	\N	0
4	recurring-job:refresh-student-skill-profiles	Job	{"Type":"CourseMate.Application.BackgroundJobs.RefreshStudentSkillProfilesJob, CourseMate.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null","Method":"ExecuteAsync","ParameterTypes":"[\\"System.Threading.CancellationToken, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e\\"]","Arguments":"[null]"}	\N	0
5	recurring-job:refresh-student-skill-profiles	CreatedAt	2026-07-08T11:49:52.1078650Z	\N	0
6	recurring-job:refresh-student-skill-profiles	NextExecution	2026-07-09T03:00:00.0000000Z	\N	0
7	recurring-job:refresh-student-skill-profiles	V	2	\N	0
8	recurring-job:build-course-similarity	Queue	default	\N	0
9	recurring-job:build-course-similarity	Cron	0 0 * * *	\N	0
10	recurring-job:build-course-similarity	TimeZoneId	UTC	\N	0
11	recurring-job:build-course-similarity	Job	{"Type":"CourseMate.Application.BackgroundJobs.BuildCourseSimilarityJob, CourseMate.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null","Method":"ExecuteAsync","ParameterTypes":"[\\"System.Threading.CancellationToken, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e\\"]","Arguments":"[null]"}	\N	0
12	recurring-job:build-course-similarity	CreatedAt	2026-07-08T11:49:52.2380504Z	\N	0
13	recurring-job:build-course-similarity	NextExecution	2026-07-09T00:00:00.0000000Z	\N	0
14	recurring-job:build-course-similarity	V	2	\N	0
15	recurring-job:build-course-cooccurrence	Queue	default	\N	0
16	recurring-job:build-course-cooccurrence	Cron	0 0 * * *	\N	0
17	recurring-job:build-course-cooccurrence	TimeZoneId	UTC	\N	0
18	recurring-job:build-course-cooccurrence	Job	{"Type":"CourseMate.Application.BackgroundJobs.BuildCoOccurrenceJob, CourseMate.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null","Method":"ExecuteAsync","ParameterTypes":"[\\"System.Threading.CancellationToken, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e\\"]","Arguments":"[null]"}	\N	0
19	recurring-job:build-course-cooccurrence	CreatedAt	2026-07-08T11:49:52.2526827Z	\N	0
20	recurring-job:build-course-cooccurrence	NextExecution	2026-07-09T00:00:00.0000000Z	\N	0
21	recurring-job:build-course-cooccurrence	V	2	\N	0
22	recurring-job:build-user-recommendations	Queue	default	\N	0
23	recurring-job:build-user-recommendations	Cron	0 0 * * *	\N	0
24	recurring-job:build-user-recommendations	TimeZoneId	UTC	\N	0
25	recurring-job:build-user-recommendations	Job	{"Type":"CourseMate.Application.BackgroundJobs.BuildUserRecommendationsJob, CourseMate.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null","Method":"ExecuteAsync","ParameterTypes":"[\\"System.Threading.CancellationToken, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e\\"]","Arguments":"[null]"}	\N	0
26	recurring-job:build-user-recommendations	CreatedAt	2026-07-08T11:49:52.2666471Z	\N	0
27	recurring-job:build-user-recommendations	NextExecution	2026-07-09T00:00:00.0000000Z	\N	0
28	recurring-job:build-user-recommendations	V	2	\N	0
\.
...
1	5	Succeeded	{"Type": "CourseMate.Application.BackgroundJobs.GenerateLessonMaterialEmbeddingJob, CourseMate.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Method": "ExecuteAsync", "Arguments": "[\\"\\\\\\"60f3e9a9-e6bc-464c-b688-d62d314e333d\\\\\\"\\",null]", "ParameterTypes": "[\\"System.Guid, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e\\",\\"System.Threading.CancellationToken, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e\\"]"}	["\\"60f3e9a9-e6bc-464c-b688-d62d314e333d\\"", null]	2026-07-08 12:04:37.419562+00	2026-07-09 12:04:43.713131+00	0
2	7	Succeeded	{"Type": "CourseMate.Application.BackgroundJobs.GenerateOutlineJob, CourseMate.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Method": "ExecuteAsync", "Arguments": "[\\"\\\\\\"60f3e9a9-e6bc-464c-b688-d62d314e333d\\\\\\"\\",\\"0\\",null]", "ParameterTypes": "[\\"System.Guid, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e\\",\\"CourseMate.Contracts.Enums.LessonMaterialPromptType, CourseMate.Contracts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null\\",\\"System.Threading.CancellationToken, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e\\"]"}	["\\"60f3e9a9-e6bc-464c-b688-d62d314e333d\\"", "0", null]	2026-07-08 12:04:37.476748+00	2026-07-09 12:05:10.307543+00	0
\.
...
1	1	CurrentCulture	"en-US"	0
2	1	CurrentUICulture	"en-US"	0
3	2	CurrentCulture	"en-US"	0
4	2	CurrentUICulture	"en-US"	0
5	1	Continuations	[{"JobId":"2","Options":1}]	0
\.
...
1	1	default	2026-07-08 12:04:40.603307+00	0
2	2	default	2026-07-08 12:04:43.709725+00	0
\.
...
desktop-k8hlp07:17480:c892a35c-3834-43fd-a653-f7e4e1a44ca6	{"Queues": ["default"], "StartedAt": "2026-07-08T11:49:52.4985465Z", "WorkerCount": 20}	2026-07-08 12:05:57.670318+00	0
\.
...
1	recurring-jobs	1783566000	refresh-student-skill-profiles	\N	0
2	recurring-jobs	1783555200	build-course-similarity	\N	0
3	recurring-jobs	1783555200	build-course-cooccurrence	\N	0
4	recurring-jobs	1783555200	build-user-recommendations	\N	0
\.
...
1	1	Enqueued	\N	2026-07-08 12:04:37.458039+00	{"Queue": "default", "EnqueuedAt": "2026-07-08T12:04:37.4029545Z"}	0
2	2	Awaiting	\N	2026-07-08 12:04:37.54839+00	{"Options": "OnlyOnSucceededState", "ParentId": "1", "NextState": "{\\"$type\\":\\"Hangfire.States.EnqueuedState, Hangfire.Core\\",\\"Queue\\":\\"default\\",\\"Reason\\":null}", "Expiration": "365.00:00:00"}	0
3	1	Processing	\N	2026-07-08 12:04:38.516522+00	{"ServerId": "desktop-k8hlp07:17480:c892a35c-3834-43fd-a653-f7e4e1a44ca6", "WorkerId": "506ec6c9-91f7-4bfe-8746-9491f6d07345", "StartedAt": "2026-07-08T12:04:37.4832351Z"}	0
4	2	Enqueued	\N	2026-07-08 12:04:40.857834+00	{"Queue": "default", "EnqueuedAt": "2026-07-08T12:04:40.8484165Z"}	0
5	1	Succeeded	\N	2026-07-08 12:04:40.869415+00	{"Latency": "-25198893", "SucceededAt": "2026-07-08T12:04:40.8240218Z", "PerformanceDuration": "2297"}	0
6	2	Processing	\N	2026-07-08 12:04:40.87169+00	{"ServerId": "desktop-k8hlp07:17480:c892a35c-3834-43fd-a653-f7e4e1a44ca6", "WorkerId": "b27f86f6-d02d-4611-a669-2877e49a6b6c", "StartedAt": "2026-07-08T12:04:40.8658808Z"}	0
7	2	Succeeded	\N	2026-07-08 12:05:06.916948+00	{"Latency": "-25196598", "SucceededAt": "2026-07-08T12:05:06.9079788Z", "PerformanceDuration": "26030"}	0
\.
...
COPY public."AspNetUsers" ("Id", "UserName", "NormalizedUserName", "Email", "NormalizedEmail", "EmailConfirmed", "PasswordHash", "SecurityStamp", "ConcurrencyStamp", "PhoneNumber", "PhoneNumberConfirmed", "TwoFactorEnabled", "LockoutEnd", "LockoutEnabled", "AccessFailedCount", "CreationTime", "IsDeleted", "LastModificationTime", "IsApproved") FROM stdin;
019ddd8c-f558-7386-a796-18c878996313	instructor1	INSTRUCTOR1	instructor1@example.com	INSTRUCTOR1@EXAMPLE.COM	t	AQAAAAIAAYagAAAAECLEQG4R0lvdiQBVtSZHn/7HzUaa6nxckzrTEI5vRwx5YOnOU3l/hOlTmoEyyRat2w==	SQCSJXFSKXUB3QHMSFKD43HJFV4DHS7L	deceffae-c057-4718-b303-a8ae3b5301e3	\N	f	f	\N	t	0	-infinity	f	\N	t
019ddd8c-f5b5-756c-b9a4-759ab4ffa4cf	instructor2	INSTRUCTOR2	instructor2@example.com	INSTRUCTOR2@EXAMPLE.COM	t	AQAAAAIAAYagAAAAEM2OpN79n/LUE50XqZ0ClOBvajhvhHrrrBQnMagJRStWuVyTVpYFJElIvksXiWHQ6Q==	ELTWCHJVMM56QZK7KFAUGTX4OKOJNSSE	618d7b9a-7863-49df-bd2a-6dec54276444	\N	f	f	\N	t	0	-infinity	f	\N	t
019ddd8c-f603-72ac-a914-255b7bfd9e64	instructor3	INSTRUCTOR3	instructor3@example.com	INSTRUCTOR3@EXAMPLE.COM	t	AQAAAAIAAYagAAAAEPmCzlIKwseI3PcRHPxsdFGAsV7GVG6DSig445hirDxlMC7sSZgdEA30WCykUS+5Hg==	F3X624PI2QYP2JZXHIN6GI2KEV4J6MKM	6ffaa219-b558-4604-89a5-cd404da49119	\N	f	f	\N	t	0	-infinity	f	\N	t
019ddd8c-f426-7111-910a-6cb2e5c6a751	admin	ADMIN	admin@example.com	ADMIN@EXAMPLE.COM	t	AQAAAAIAAYagAAAAEEurpVw9O7P5Zdaj4ZYQfzOYRMw0+u1/dpgkfXZIQm3k+chZBofgmmQpCgyv++pgCg==	WAWEHN6HYMHT2HRHSOD62BKRKBK2UBRC	c58a3fc6-4f6b-484b-92e7-f08045d80024	\N	f	f	\N	t	0	-infinity	f	\N	t
019ddd8c-f4fa-7bde-85b5-838e03cde051	manager	MANAGER	manager@example.com	MANAGER@EXAMPLE.COM	t	AQAAAAIAAYagAAAAECaF56EvDFbemgisT4hSJbOz4rqHFdGFPx5RoxIplLE9zX2YvZRYyQysG/zJFgSzmg==	4AO2GXNI3LDIGRNWCRLSZOQYKR4NH4FC	9bbf4557-20a5-497a-ac8c-ec4d7e9af35c	\N	f	f	\N	t	0	-infinity	f	\N	t
019ddd8c-f65a-7ad2-a4fa-1a6f00d0d1cb	student1	STUDENT1	student1@example.com	STUDENT1@EXAMPLE.COM	t	AQAAAAIAAYagAAAAELT5HrApghXkZWrUR9s96l77q86a+qc6WHJXp+5L8RaUAHSGCubUW+pHCOk7RRRQEA==	AQ2ACDW4WXI2VPWDEJ5NNCZPFF7PZFCA	a7c33d9d-6dec-414c-bde6-3165e418f750	\N	f	f	\N	t	0	-infinity	f	\N	t
019ddd8c-f6e1-7511-94bd-0a10582186a3	student2	STUDENT2	student2@example.com	STUDENT2@EXAMPLE.COM	t	AQAAAAIAAYagAAAAENUQpKP13GLVFbjCzauO/9LOS0t/e9QV0S6DzTMPrHASZHxaUwIMhGAUCDNHixBgVg==	HCF3OGSPWI5O3SKBWNHTTAAKPOBPQ5HL	caab734a-dfed-403b-81c9-e40559cb4997	\N	f	f	\N	t	0	-infinity	f	\N	t
019ddd8c-f773-7d46-9bf6-03a520cda5da	student3	STUDENT3	student3@example.com	STUDENT3@EXAMPLE.COM	t	AQAAAAIAAYagAAAAEEMicP44dHmYYPnEbZqR/vSiZ9vitVpv49w9awB74983wHoqicZXD1xW2NGK723I0A==	3NV43Z7PGAHBNI5LPLOXXPOZFB7YA752	b37678ab-96fc-4fcd-91bf-13b14447ecc7	\N	f	f	\N	t	0	-infinity	f	\N	t
\.
...
COPY public."ChatConversations" ("Id", "UserId", "Title", "CourseId", "LessonId", "CreationTime", "LastModificationTime", "IsDeleted") FROM stdin;
\.
...
COPY public."ChatMessages" ("Id", "ConversationId", "Role", "Content", "SourceChunkIds", "CreationTime", "LastModificationTime", "UserId", "IsDeleted") FROM stdin;
\.
...
--
-- Data for Name: ContestPrizes; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."ContestPrizes" ("Id", "ContestId", "CourseId", "MinRank", "CreationTime", "LastModificationTime", "UserId", "IsDeleted", "MaxRank") FROM stdin;
\.
...
--
-- Data for Name: CourseCoOccurrences; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."CourseCoOccurrences" ("Id", "CourseId", "CoCourseId", "Weight", "CoCount", "CreationTime", "LastModificationTime", "UserId", "IsDeleted") FROM stdin;
\.


--
-- Data for Name: CourseEmbeddings; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."CourseEmbeddings" ("Id", "CourseId", "Embedding", "CreationTime", "LastModificationTime", "UserId", "IsDeleted") FROM stdin;
\.


--
-- Data for Name: CourseSimilarities; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."CourseSimilarities" ("Id", "CourseId", "SimilarCourseId", "Score", "CreationTime", "LastModificationTime", "UserId", "IsDeleted") FROM stdin;
\.
...
19e99329-4e14-4381-94e4-578bc988cee8	019ddd8c-f65a-7ad2-a4fa-1a6f00d0d1cb	7e7c3458-5caa-43c3-84d7-383ac98097f1	\N	2026-06-11 09:40:17.44595+00	\N	f
21f00d94-f0e8-4d4a-8451-380f4ae98d86	019ddd8c-f65a-7ad2-a4fa-1a6f00d0d1cb	3600145f-dbec-412b-94f1-08942f6afa16	\N	2026-06-11 09:40:17.44595+00	\N	f
3d3180cc-e4b8-463f-97ac-594a0e1a5dd2	019ddd8c-f773-7d46-9bf6-03a520cda5da	3600145f-dbec-412b-94f1-08942f6afa16	\N	2026-06-11 09:40:17.44595+00	\N	f
627f21c0-b11d-4baf-977e-95df9665bc5a	019ddd8c-f6e1-7511-94bd-0a10582186a3	3600145f-dbec-412b-94f1-08942f6afa16	\N	2026-06-11 09:40:17.44595+00	\N	f
6d8e8fc8-df5b-4fb3-8ff7-b6f802712973	019ddd8c-f6e1-7511-94bd-0a10582186a3	7e7c3458-5caa-43c3-84d7-383ac98097f1	\N	2026-06-11 09:40:17.44595+00	\N	f
a1f74793-e575-4c8f-b500-4b8318752d7d	019ddd8c-f6e1-7511-94bd-0a10582186a3	820b7ae8-fcf9-46f4-b206-36d3bc57a496	\N	2026-06-11 09:40:17.44595+00	\N	f
c603dc67-04ca-445e-b56b-f1221484dad3	019ddd8c-f773-7d46-9bf6-03a520cda5da	820b7ae8-fcf9-46f4-b206-36d3bc57a496	\N	2026-06-11 09:40:17.44595+00	\N	f
f3ba2afb-3a62-4b02-a417-25a0de899507	019ddd8c-f773-7d46-9bf6-03a520cda5da	7e7c3458-5caa-43c3-84d7-383ac98097f1	\N	2026-06-11 09:40:17.44595+00	\N	f
fab9f2eb-5c4e-4e22-97c6-d987cfe54276	019ddd8c-f65a-7ad2-a4fa-1a6f00d0d1cb	820b7ae8-fcf9-46f4-b206-36d3bc57a496	\N	2026-06-11 09:40:17.44595+00	\N	f
\.
...
1ab4513c-bf9c-4a9c-8105-291cca76b23d	e88bedd1-5717-4075-8896-586b5a19ca64	javascript	const lines = require('fs').readFileSync('/dev/stdin','utf8').trim().split('\\n');\nconst n = parseInt(lines[0]);\nconst arr = lines[1].split(' ').map(Number);\nconst target = parseInt(lines[2]);\n// Viết code của bạn tại đây\n	\N	2026-06-11 09:40:17.44595+00	\N	f
1df6cefb-f5b0-4ba6-89cd-8ab8d1d6a1b9	c236023c-df66-46a5-b8db-22b2f08adc97	python	a, b = map(int, input().split())\n# Viết code của bạn tại đây\n	\N	2026-06-11 09:40:17.44595+00	\N	f
25ec3311-5396-4142-a1b3-e58aba75f24a	e88bedd1-5717-4075-8896-586b5a19ca64	python	n = int(input())\narr = list(map(int, input().split()))\ntarget = int(input())\n# Viết code của bạn tại đây\n	\N	2026-06-11 09:40:17.44595+00	\N	f
65bd3d02-f3bb-4518-9c0e-d0091c8353d4	bbcbf4ee-9282-4fe6-874d-9763e52f84a6	python	s = input()\n# Viết code của bạn tại đây\n# Output: true hoặc false\n	\N	2026-06-11 09:40:17.44595+00	\N	f
6727f822-dc79-482a-abaf-8a5f728d7bc8	bbcbf4ee-9282-4fe6-874d-9763e52f84a6	javascript	const s = require('fs').readFileSync('/dev/stdin','utf8').trim();\n// Viết code của bạn tại đây\n// Output: true hoặc false\n	\N	2026-06-11 09:40:17.44595+00	\N	f
ea85cc66-9201-45dc-9cf7-01c3c4c981cc	c236023c-df66-46a5-b8db-22b2f08adc97	javascript	const [a, b] = require('fs').readFileSync('/dev/stdin','utf8').trim().split(' ').map(Number);\n// Viết code của bạn tại đây\n	\N	2026-06-11 09:40:17.44595+00	\N	f
\.
...
326f1b08-9dd7-45f7-8f3f-09f89d69bab1	3\n1 2 3\n5	-1	target=5 không có trong mảng	e88bedd1-5717-4075-8896-586b5a19ca64	\N	2026-06-11 09:40:17.44595+00	\N	f
6396abf3-08b2-47df-aaf1-40d2b6a27fb5	1 2	3	1 + 2 = 3	c236023c-df66-46a5-b8db-22b2f08adc97	\N	2026-06-11 09:40:17.44595+00	\N	f
9e19da94-6776-41b0-b0ba-37a7d768758f	racecar	true	"racecar" đọc ngược vẫn là "racecar"	bbcbf4ee-9282-4fe6-874d-9763e52f84a6	\N	2026-06-11 09:40:17.44595+00	\N	f
a68b2bc2-6a6f-49da-b034-c393c509e63c	hello	false	"hello" đọc ngược là "olleh"	bbcbf4ee-9282-4fe6-874d-9763e52f84a6	\N	2026-06-11 09:40:17.44595+00	\N	f
bbec242c-93a2-4256-a699-88f98abff2a7	5\n1 3 5 7 9\n3	1	target=3 tại chỉ số 1	e88bedd1-5717-4075-8896-586b5a19ca64	\N	2026-06-11 09:40:17.44595+00	\N	f
c1455e7b-5567-4edc-9331-390f4689965f	-1 5	4	-1 + 5 = 4	c236023c-df66-46a5-b8db-22b2f08adc97	\N	2026-06-11 09:40:17.44595+00	\N	f
\.
...
d9b30964-3bc5-40c1-88ce-0f84f4b40a4c	e88bedd1-5717-4075-8896-586b5a19ca64	python-3.14	import sys\n\ndef solve():\n    # Đọc dữ liệu từ stdin\n    # input_data = sys.stdin.read().split()\n    \n    # Logic của bạn ở đây\n    print("Xin chao Python")\n\nif __name__ == "__main__":\n    solve()	f	0	0.4114	55964	\N	2026-07-08 11:54:49.812982+00	\N	f
3ba8bb63-5527-4c9f-aec2-1a941c155051	e88bedd1-5717-4075-8896-586b5a19ca64	python-3.14	import sys\n\ndef solve():\n    # Đọc dữ liệu từ stdin\n    # input_data = sys.stdin.read().split()\n    \n    # Logic của bạn ở đây\n    print("Xin chao Python")\n\nif __name__ == "__main__":\n    solve()	f	0	0.9165000000000001	56652	\N	2026-07-08 11:55:22.848909+00	\N	f
c5039310-0a0c-40c1-81c6-9569e4f4c37c	c236023c-df66-46a5-b8db-22b2f08adc97	python-3.14	import sys\n\ndef solve():\n    # Đọc dữ liệu từ stdin\n    # input_data = sys.stdin.read().split()\n    \n    # Logic của bạn ở đây\n    print("Xin chao Python")\n\nif __name__ == "__main__":\n    solve()	f	0	0.44279999999999997	55924	\N	2026-07-08 11:55:59.228932+00	\N	f
72431a7b-b531-4693-9835-ebf420a9971a	bbcbf4ee-9282-4fe6-874d-9763e52f84a6	python-3.14	import sys\n\ndef solve():\n    # Đọc dữ liệu từ stdin\n    # input_data = sys.stdin.read().split()\n    \n    # Logic của bạn ở đây\n    print("Xin chao Python")\n\nif __name__ == "__main__":\n    solve()	f	0	0.5823	55564	\N	2026-07-08 11:56:47.819511+00	\N	f
\.
...
03410097-83ce-450a-b5d7-b5a2c05dcff4	bbcbf4ee-9282-4fe6-874d-9763e52f84a6	hello	false	Không phải palindrome	f	2	\N	2026-06-11 09:40:17.44595+00	\N	f
18a686eb-27de-45e4-9f3b-34676784a826	c236023c-df66-46a5-b8db-22b2f08adc97	1 2	3	1 + 2 = 3	f	1	\N	2026-06-11 09:40:17.44595+00	\N	f
1925f972-4826-4860-89e4-f672f7a933d0	c236023c-df66-46a5-b8db-22b2f08adc97	1000000000 999999999	1999999999	Số lớn	t	4	\N	2026-06-11 09:40:17.44595+00	\N	f
29ca795f-2680-4341-ac83-abe0f7d9f81f	c236023c-df66-46a5-b8db-22b2f08adc97	-5 10	5	Số âm + số dương	t	3	\N	2026-06-11 09:40:17.44595+00	\N	f
333700b8-1119-496d-b9eb-a071d023f8e1	e88bedd1-5717-4075-8896-586b5a19ca64	5\n1 3 5 7 9\n10	-1	Không tìm thấy	f	3	\N	2026-06-11 09:40:17.44595+00	\N	f
5443f74a-a123-4a43-a39b-e4d8b1031427	bbcbf4ee-9282-4fe6-874d-9763e52f84a6	A man a plan a canal Panama	true	Palindrome nhiều từ	t	3	\N	2026-06-11 09:40:17.44595+00	\N	f
79a6da56-aafb-4511-bcb5-a863125adb75	c236023c-df66-46a5-b8db-22b2f08adc97	0 0	0	0 + 0 = 0	f	2	\N	2026-06-11 09:40:17.44595+00	\N	f
7b5fb8a3-d6d2-42fd-8d49-687a46d79648	bbcbf4ee-9282-4fe6-874d-9763e52f84a6	Was it a car or a cat I saw	true	Palindrome có dấu câu	t	4	\N	2026-06-11 09:40:17.44595+00	\N	f
95055a9d-3aae-482c-8d0c-941dd1062a61	bbcbf4ee-9282-4fe6-874d-9763e52f84a6	racecar	true	Palindrome đơn từ	f	1	\N	2026-06-11 09:40:17.44595+00	\N	f
cdfc178c-9b88-418d-9308-37f359d34dc8	e88bedd1-5717-4075-8896-586b5a19ca64	5\n1 3 5 7 9\n3	1	Tìm thấy ở giữa	f	1	\N	2026-06-11 09:40:17.44595+00	\N	f
d4495337-2e4d-4168-a901-805ad6fff91f	e88bedd1-5717-4075-8896-586b5a19ca64	1\n5\n5	0	Mảng một phần tử	t	4	\N	2026-06-11 09:40:17.44595+00	\N	f
d926f9dd-3f06-45ea-80e1-0a2e6f929956	e88bedd1-5717-4075-8896-586b5a19ca64	5\n1 3 5 7 9\n1	0	Tìm thấy đầu mảng	f	2	\N	2026-06-11 09:40:17.44595+00	\N	f
\.
...
bbcbf4ee-9282-4fe6-874d-9763e52f84a6	Kiểm tra chuỗi Palindrome	Cho một chuỗi s, kiểm tra xem s có phải palindrome không (chỉ xét ký tự chữ-số, không phân biệt hoa thường). In "true" hoặc "false".	0	String	019ddd8c-f558-7386-a796-18c878996313	["Chỉ xét ký tự chữ cái và chữ số", "Không phân biệt hoa thường"]	["So sánh chuỗi đã chuẩn hoá với bản đảo ngược của nó"]	\N	2026-06-11 09:40:17.44595+00	\N	f	f
c236023c-df66-46a5-b8db-22b2f08adc97	Tính tổng hai số	Cho hai số nguyên a và b trên một dòng, in ra tổng của chúng.	0	Math	019ddd8c-f558-7386-a796-18c878996313	["Giá trị a, b nằm trong khoảng [-10^9, 10^9]"]	["Dùng toán tử + để cộng hai số"]	\N	2026-06-11 09:40:17.44595+00	\N	f	f
e88bedd1-5717-4075-8896-586b5a19ca64	Tìm kiếm nhị phân	Cho mảng n số nguyên đã sắp xếp tăng dần và một số target. Trả về chỉ số (0-based) của target trong mảng; nếu không tìm thấy trả về -1.	1	Array	019ddd8c-f558-7386-a796-18c878996313	["Mảng đã sắp xếp tăng dần", "Yêu cầu độ phức tạp O(log n)"]	["Dùng hai con trỏ left/right", "Tính mid = (left + right) / 2 để tránh tràn số"]	\N	2026-06-11 09:40:17.44595+00	\N	f	f
\.
...
692e0715-757c-4847-aa43-f9d8bd13c7de	ae86817c-cbc2-4358-b631-798544690908	1	temp\\ae86817c-cbc2-4358-b631-798544690908_chunk1.txt	887	t	\N	2026-07-08 12:04:40.722528+00	\N	f
\.
...
ae86817c-cbc2-4358-b631-798544690908	ae86817c-cbc2-4358-b631-798544690908.docx	14258	019ddd8c-f426-7111-910a-6cb2e5c6a751\\ae86817c-cbc2-4358-b631-798544690908.docx	1	2	2	2026-07-08 12:04:37.275788+00	2	\N	2026-07-08 12:04:37.366453+00	2026-07-08 12:04:40.722528+00	f
\.
...
8031b37d-ca10-4356-939a-b40d5cb43ad6	ae86817c-cbc2-4358-b631-798544690908	692e0715-757c-4847-aa43-f9d8bd13c7de	0	886	OOP (Object-Oriented Programming) là lập trình hướng đối tượng.4 tính chất chính của OOP:1. Encapsul	[0.014916169,-0.017800463,0.03389048,-0.054834772,-0.03210552,0.027980246,0.0050273067,0.029262131,0.020120934,-0.012097342,-0.015203909,-0.0022660212,-0.019999128,-0.019436983,0.14309277,0.013977523,-0.007373567,-0.00045672004,0.011949301,0.00053051143,0.002058455,-0.016872818,0.026205098,-0.026346002,0.009124215,-0.031049326,0.013441517,0.0136036435,0.053026073,-0.006585099,-0.010881906,0.060531985,0.024720458,-0.005630854,-0.010150897,-0.011965881,0.004145071,-0.012905998,0.01034438,0.0035685492,-0.017365085,0.013595487,0.003984894,0.011489577,-0.015702235,-0.0041708997,-0.004256287,-0.014802745,0.0026342361,0.01734623,0.009779069,-0.019569315,0.0001717949,-0.17090434,-0.017492747,-0.001102058,-0.008764647,-0.018624585,0.00267026,-0.00045149316,0.008529935,0.017355347,-0.0052150236,0.012817503,0.014997826,-0.035370443,0.014655189,0.011439179,-0.01557784,-0.0075324997,0.016248774,0.027547246,-0.03347145,-0.0054812026,0.022122035,-0.020576514,0.017723989,-0.00073734985,0.0036443637,0.0021960898,-0.015765997,-0.00814548,-0.019988434,-0.014452844,-0.0048933355,-0.034961745,-0.01386858,-0.038693044,0.0035658206,0.0057116454,0.06503797,0.010871992,0.004778999,0.050748013,-0.0023923435,-0.011601609,-0.02859533,0.009936059,0.0089841345,0.019159997,0.00540979,-0.038347796,0.0076524154,-0.0006980117,-0.008098106,0.0006743961,0.021165097,-0.013306774,-0.0032076628,0.023534795,0.0013714917,-0.028793475,0.009315248,0.0055105924,-0.008007727,-0.15198556,-0.0048785633,-0.0052401256,-0.024372248,-0.0048077675,-0.00770658,-0.006461462,0.0072346716,0.0014647967,-0.03677036,-0.017973252,0.013383051,0.022967476,0.045353975,0.011385884,0.0012047613,-0.013047375,0.03248564,0.016597962,-0.0039371257,0.022260848,-0.0029196187,-0.009242555,-0.028117472,0.0044374033,-0.020809837,0.006028992,-0.0056398734,0.020010985,-0.033774633,-0.011113156,-0.03288494,0.018421784,-0.002656315,-0.011807451,0.013375224,-0.008296091,-0.031564075,-0.011888733,-0.0057186335,-0.00522994,0.01306793,-0.015394155,-0.0099605005,0.017330134,-0.0057646115,0.017639197,-0.011450756,0.0017235863,0.004957446,0.00840235,-0.031105379,0.0021729637,0.021077422,0.026106725,0.00773807,0.024032399,0.0073975185,0.01970605,0.009498781,-0.019034391,-0.010229208,-0.00935451,0.006260147,0.002019517,0.006319846,0.013203601,0.008785426,0.0012605143,-0.02072793,-0.011765976,-0.00070724037,0.0045078574,0.0071841646,0.009375291,0.014425084,-0.00414833,0.0061571132,-0.026334528,0.012832255,-0.029629055,-0.0042935717,0.0040746354,-0.0096392725,0.014005454,0.0019290252,0.01681978,0.009503781,-0.010624198,-0.009568911,-0.011564418,0.003693035,-0.01617044,-0.0016168009,0.02636572,-0.008843501,-0.008872785,0.033091057,-0.017132118,0.0029971013,-0.04335559,-0.007768255,-0.021041857,0.0019049196,0.0012204049,-0.0020986516,0.0030884333,-0.006645546,0.037885766,0.014586901,-0.0021740037,-0.005129201,0.008023016,0.0045891837,-0.019985417,-0.005356219,-0.014429521,-0.022053512,0.036952347,0.01936429,-0.011737985,-0.00022214171,0.023549326,0.005789239,-0.007208796,-0.033797897,0.017520621,0.026883997,0.025569987,0.030302465,0.00017627838,-0.013568022,0.047256656,-0.008901454,-0.011599031,-0.0057705874,-0.009906066,-0.019572316,-0.0033265953,0.004816865,-0.028382953,-0.012017266,0.041515224,-0.00774409,-0.016787343,0.0009878253,0.013482763,-0.018936686,-0.028731309,0.028360575,0.02030341,-0.014340005,0.018427154,-0.003268246,-0.0077505135,-0.0034170018,0.023217836,0.0038229136,0.03207311,-0.01989745,-0.004677534,-0.05478514,0.043813862,-0.00417896,-0.016993385,0.030872583,-0.02495377,-0.023255073,-0.004754545,0.0059744637,0.0062320805,-0.021530576,-0.018981706,-0.0092928875,-0.015114776,0.0072332746,0.009029066,-0.025411567,-0.0066042556,0.019933103,-0.0138129415,-0.027247936,-0.0119361235,0.0064498684,0.01610524,-0.007393303,-0.024753626,0.017487882,0.010333116,-0.0019551155,0.0013884811,-0.010220767,0.016499942,-0.012309415,-0.023441758,0.0074385707,-0.0037305963,0.017968409,-0.015103344,0.008162862,-0.015772352,0.018195115,0.020173706,0.01148805,0.008982933,-0.012561982,0.017027954,0.0069917245,0.01129078,-0.004163093,-0.0005096103,0.0064406763,-0.00012991598,0.033302594,-0.012318112,0.00053209293,0.0010204575,0.03754211,-0.006952792,0.01513285,-0.011455758,0.0014640463,0.003048232,-0.03349938,0.0033173591,0.009937697,0.02390384,-0.02463814,-0.021896588,-0.018467905,0.03426596,0.003965846,-0.022983007,-0.011459089,-0.009918764,0.0037114026,0.0026659558,0.0114001315,-0.005698859,-0.018251982,-0.001837948,-0.023717334,-0.009826064,0.027832495,0.031574335,0.0017676906,0.020229682,0.013022771,-0.012313006,0.0067953877,-0.01751032,0.008238327,0.021967815,0.0064421743,-0.0045151105,-0.027985724,-0.018646719,-0.031532217,0.00044108418,-0.016908864,0.024260452,-0.04335956,-0.004664253,-0.008426206,0.0026879113,0.009669052,-0.00019159462,-0.01682706,0.0007727447,-0.011393639,0.007875399,0.016432496,-0.0019507584,-0.008442796,0.0011851194,-0.023207737,-0.017446488,-0.013990543,0.020957157,-0.0067895283,-0.040260363,-0.021823896,-0.0060089855,0.010056136,0.01651759,0.001632093,-0.0067095947,-0.007884771,-0.005828177,-0.01011094,0.0035440507,-0.008098418,0.004950514,-0.03613991,-0.016729508,-0.014752977,0.0093273595,0.020929404,0.008253443,0.0072837193,0.019746661,-0.030451773,-0.0033839943,0.01668215,-0.0013735001,0.012294456,0.01326834,-0.009052863,-0.008299244,-0.007837576,0.003500815,-0.039309625,0.002033942,-0.011806486,-0.0018902053,0.024718212,0.024339003,0.0058773565,-0.017598292,0.0040542046,-0.005327721,-0.0024020462,-0.012991958,0.0007933877,-0.0036829829,0.025357904,-0.024948366,0.01155772,0.0016920763,0.020281076,-0.01270382,0.016234415,-0.033513054,-0.0051326696,0.0009585041,1.5289414e-05,0.022444401,0.01992736,-0.0004716447,0.01590173,0.020972999,0.011910706,0.0105734775,-0.020079503,-0.018489644,0.0026688054,-0.002614836,-0.004140234,-0.018130032,-0.02917167,0.0028264278,0.0036748084,-0.01737728,-0.0016021042,0.014344944,-0.0033702457,0.013858151,0.012101793,0.011979972,-0.002684197,0.011145882,-0.009694737,-0.009228948,-0.02890274,-0.025788125,-0.011100131,-0.010459877,-0.00516697,0.0031550769,0.022900771,-0.015015035,0.008649554,-0.01234362,0.0055165314,-0.0051523345,-0.028945953,-0.014050595,0.037921205,-0.018895859,-0.007885087,0.008750665,-0.0232481,-0.019284198,-0.0007333746,-0.027665708,0.0011424648,-0.019469159,0.004485754,-0.0038320685,-0.003226874,0.027813986,-0.0018776815,-0.040377636,-0.0057933996,-0.020946663,-0.0026030757,0.0017625206,0.0051695355,-0.0074396133,-0.0075006667,-0.008973896,-0.0056280675,0.008833904,0.00010963194,0.0015662427,0.0055370918,0.006416438,-0.0036299888,-0.0073691495,-0.013083206,0.01868909,0.005198015,0.00068764423,-0.0017299409,0.011210404,0.0011426972,0.009147034,0.005007167,-0.014464616,0.0015575762,-0.014508852,0.006186052,-0.010845944,-0.0008991261,-0.012462641,-0.022040524,0.011829159,0.0042972076,-0.028434267,0.03362163,-0.08753471,-0.026278969,-0.006918812,0.01605486,0.0092913,-0.013754583,-0.016799746,0.004174239,0.0034422823,-0.014734032,0.02853716,-0.004355095,-0.022133559,0.010868069,0.018662786,-0.018120239,-0.011060164,-0.0036285173,0.028954169,-0.000680483,0.00087962893,0.011286679,-0.0023554233,0.0051517277,-0.013226692,0.00021011633,-0.0021056272,0.000914554,0.0052084937,-0.007639851,-0.006554823,-0.009062957,-0.0058355434,0.006593709,-0.014341792,-0.0125797875,0.030909203,0.014433653,0.0032015536,0.013347718,-0.026852543,-0.017357415,0.015538732,-0.016162798,0.008635623,0.01014272,0.007137761,0.0060545006,-0.00062718306,0.007764718,-0.005798282,-0.037817813,-0.0039335187,-0.016838107,0.017858278,-0.0062443553,0.011541809,0.000733802,0.006080795,-0.005203096,0.011772973,-0.014940453,0.034434266,0.010588439,0.013334338,0.01338192,0.02250015,-0.012180887,-0.031170705,0.022217194,-0.02713778,0.007830352,-0.026933674,0.03442492,0.011728293,-0.0015152196,-0.010853651,0.030805228,-0.010144715,0.007271022,-0.03542574,0.0091114985,-0.09383255,-0.0030496859,0.020815551,-0.018165637,0.029811133,-0.0035379203,0.014404658,0.023253212,-0.021317607,-0.022844357,0.019125177,-0.01205298,0.0012328923,-0.010363625,0.019261735,0.017162576,-0.012081555,-0.010802327,-0.029240424,-0.010493198,-0.007071268,0.010017596,0.00930587,-0.012948353,0.00015214583,0.0020848124,0.0019069948,0.012810244,-0.016294353,0.0037764742,-0.0030223143,-0.13512382,0.0030748602,0.010702563,-0.012244401,-0.014474828,0.0041015027,-0.020813651,-0.06283352,0.00722771,0.00016546619,0.0098573435,-0.018381715,-0.0193822,-0.014696186,0.009617724,0.08102404,-0.009173725,-0.0023855949,-0.0060288412,0.00953801,-0.017756164,-0.016227443,-0.025817772,-0.017806102,0.040483553,-0.01585641,-0.019919088,0.019991476,0.00077701366,-0.035004742,0.017825767,0.0007799089,-0.040803507,-0.0028726456,0.00736343,0.0004492378,0.008742122,0.013578431,0.011157189,0.009520627,0.025229644,0.0046634753,0.0030758576,-0.011432453,0.015571494,0.0011477264,-0.010363989,0.0059777326,0.02726956,-0.0040315315,-0.017857082,-0.03386376,0.024900956,0.0146126,0.013912937,-0.012816198,0.0025848518,0.024997946,0.002391304,-0.016901325,-0.010978844,0.009105109,0.008519093,0.023736322,0.011629882,-0.0029780364,0.013403614,0.032623243,-0.020001909,0.023699977,-0.010716177,0.02417811,0.023085747,0.005766195,0.0061956304,-0.035174068,-0.008872055,0.023097591,0.008908842,-0.017337091,0.0046122475,-0.007819201,0.011501849,-0.002116202,0.005947268,0.0014106007,0.006516044,0.033312567,-0.003481572,-0.008467632,0.016005907,0.019760536,-0.0050732885,0.031311255,-0.023173967,0.0050937706,0.027937593,-0.0030488928,0.012309818,-0.0033799356,-0.0016923582,-0.0025914062,-0.014892023,-0.0046519223,-0.001588977,0.034075707,-0.010881538,0.024875686,0.027046273,0.03828004]	\N	2026-07-08 12:04:40.722528+00	\N	f
\.
...
60f3e9a9-e6bc-464c-b688-d62d314e333d	a54260f0-6dbc-4962-a24e-fad90d9db08c	{\n  "lessonTitle": "Introduction to Object-Oriented Programming (OOP)",\n  "relatedLinks": [\n    "https://en.wikipedia.org/wiki/Object-oriented_programming",\n    "https://www.geeksforgeeks.org/object-oriented-programming-oops-concept-in-java/",\n    "https://www.oracle.com/java/technologies/javase/oop.html"\n  ],\n  "slides": [\n    {\n      "slideNumber": 1,\n      "title": "Introduction to Object-Oriented Programming (OOP)",\n      "bullets": [\n        "Define Object-Oriented Programming (OOP) paradigm.",\n        "Understand the fundamental concepts of OOP.",\n        "Identify the core principles (pillars) of OOP.",\n        "Discuss advantages and disadvantages of using OOP."\n      ],\n      "relatedLinks": []\n    },\n    {\n      "slideNumber": 2,\n      "title": "What is Object-Oriented Programming (OOP)?",\n      "bullets": [\n        "A programming paradigm based on the concept of 'objects'.",\n        "Objects combine data (attributes) and behavior (methods).",\n        "Aims to model real-world entities and their interactions.",\n        "Contrasts with procedural programming by organizing code around data."\n      ],\n      "relatedLinks": []\n    },\n    {\n      "slideNumber": 3,\n      "title": "Core Concepts: Objects and Classes",\n      "bullets": [\n        "Class: A blueprint or template for creating objects.",\n        "Object: An instance of a class, a concrete entity.",\n        "Attributes: Data or properties that define an object's state.",\n        "Methods: Functions or actions that an object can perform."\n      ],\n      "relatedLinks": []\n    },\n    {\n      "slideNumber": 4,\n      "title": "The Four Pillars of OOP (Part 1)",\n      "bullets": [\n        "Encapsulation: Bundling data and methods within a single unit (class).",\n        "Encapsulation: Hiding the internal state and requiring interaction via public methods.",\n        "Abstraction: Showing only essential information to the user.",\n        "Abstraction: Hiding complex implementation details."\n      ],\n      "relatedLinks": [\n        "https://www.geeksforgeeks.org/encapsulation-in-java/",\n        "https://www.geeksforgeeks.org/abstraction-in-java/"\n      ]\n    },\n    {\n      "slideNumber": 5,\n      "title": "The Four Pillars of OOP (Part 2)",\n      "bullets": [\n        "Inheritance: Mechanism allowing a class to inherit properties and behaviors from another class.",\n        "Inheritance: Promotes code reusability and establishes 'is-a' relationships.",\n        "Polymorphism: The ability of an object to take on many forms.",\n        "Polymorphism: Achieved through method overriding and overloading."\n      ],\n      "relatedLinks": [\n        "https://www.geeksforgeeks.org/inheritance-in-java/",\n        "https://www.geeksforgeeks.org/polymorphism-in-java/"\n      ]\n    },\n    {\n      "slideNumber": 6,\n      "title": "Advantages of Using OOP",\n      "bullets": [\n        "Code Reusability: Inheritance allows sharing code across classes.",\n        "Maintainability: Easier to debug and modify due to modularity.",\n        "Scalability: Easier to add new features or expand existing ones.",\n        "Security: Encapsulation protects data from unintended access."\n      ],\n      "relatedLinks": []\n    },\n    {\n      "slideNumber": 7,\n      "title": "Disadvantages and Considerations of OOP",\n      "bullets": [\n        "Increased Complexity: Can be more complex for simple problems.",\n        "Performance Overhead: May introduce slight performance overhead due to abstraction layers.",\n        "Steeper Learning Curve: Requires understanding new concepts and design patterns.",\n        "Risk of Over-design: Can lead to overly complex solutions if not applied judiciously."\n      ],\n      "relatedLinks": []\n    },\n    {\n      "slideNumber": 8,\n      "title": "OOP in Action: Real-World Examples",\n      "bullets": [\n        "Car: Class 'Car', objects 'myCar', 'yourCar'; attributes 'color', 'make'; methods 'start()', 'stop()'.",\n        "Bank Account: Class 'BankAccount'; attributes 'balance', 'accountNumber'; methods 'deposit()', 'withdraw()'.",\n        "Animal Kingdom: 'Animal' as base class, 'Dog' and 'Cat' inherit; 'makeSound()' method polymorphic."\n      ],\n      "relatedLinks": []\n    },\n    {\n      "slideNumber": 9,\n      "title": "Common Misconceptions about OOP",\n      "bullets": [\n        "OOP is a programming language: It's a paradigm, implemented in many languages (Java, Python, C++).",\n        "OOP is always better than procedural: Depends on project scope and requirements.",\n        "OOP is a silver bullet: It's a tool, not a universal solution for all software problems."\n      ],\n      "relatedLinks": []\n    },\n    {\n      "slideNumber": 10,\n      "title": "Best Practices for Effective OOP",\n      "bullets": [\n        "Apply SOLID Principles: Single Responsibility, Open/Closed, Liskov Substitution, Interface Segregation, Dependency Inversion.",\n        "Use Design Patterns: Reusable solutions to common software design problems.",\n        "Keep It Simple, Stupid (KISS) and Don't Repeat Yourself (DRY).",\n        "Conduct Code Reviews: Ensure adherence to principles and maintainability."\n      ],\n      "relatedLinks": [\n        "https://en.wikipedia.org/wiki/SOLID",\n        "https://en.wikipedia.org/wiki/Software_design_pattern"\n      ]\n    },\n    {\n      "slideNumber": 11,\n      "title": "Summary and Future Outlook",\n      "bullets": [\n        "OOP organizes code around objects, emphasizing data and behavior.",\n        "Pillars: Encapsulation, Abstraction, Inheritance, Polymorphism.",\n        "Offers benefits like reusability and maintainability, but has trade-offs.",\n        "Continues to evolve, often combined with other paradigms like functional programming."\n      ],\n      "relatedLinks": []\n    }\n  ]\n}	ae86817c-cbc2-4358-b631-798544690908	2	\N	2026-07-08 12:04:37.366453+00	2026-07-08 12:05:06.891548+00	f
\.
...
fdae0a99-dee5-4e53-96bb-6d06ef0df8c8	8c2d7584-6469-496a-bdd6-7cc91c5ca423	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
fe838aca-d97d-46dd-9667-e5670aef0d81	3199beaf-27e5-4a9b-946e-4b16814c5845	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
fe9f017f-4c97-427b-ae61-d28841070b5d	4c8e0046-52b1-4ebe-891d-fae57e025e68	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ff2f0a68-9434-4281-95c8-e9ffe955462a	f29228ca-fabc-4600-b473-f9266c06df15	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ff498240-7aab-4041-952e-1cf8976e5273	a8f185e8-3386-4e78-859a-be8d65972c20	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ff53f52a-37bb-47d8-a04f-7e40a73eff9f	6c24411c-fb28-43c7-ba03-e981e82db7cb	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ff98820c-e4b7-48b0-a95d-8df0d9fd8f37	a5e7a5eb-0249-4840-a769-1240fab44348	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
00a6ca12-6bff-4fe8-a37f-de59a32ea97d	86eab7b3-9231-438c-b4b9-5485c84d81a4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
01d3d3d3-00b4-431a-b0ba-811982dc347f	2ed609d4-5cd3-4077-b6e8-20701fbd7acb	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
01f54991-634f-4bda-9f6f-28b2cbe867d4	87b1a3d7-5d0d-47e7-b117-6c85a3dbda43	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
020224ca-a627-4bcb-931b-af0c4f294633	9b689cac-3bd9-4c96-bc97-2e26578ca681	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
021036cb-b5e6-4973-92ee-ebd3f0063a4f	c923c0b3-c571-4a38-913c-3217b554b3ac	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0211b05a-0748-4766-ad96-9d7fc0981287	20876edf-7c51-4659-b84a-1a9a01e34355	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
02b4fa3c-f59c-4276-9a39-eb3d85063f17	b96034cf-814b-4f81-9f29-4c8383fc017d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
03642aba-f7b1-47a9-85b1-218b3d6b5ad8	99d4096c-8128-4853-b812-e63197d0b9f7	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0446efa1-242c-4d74-9cb9-dcef5a662b3a	64434b35-31e1-44cf-8c1d-03cd034c2892	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
04614d60-0829-4009-9de4-79dde0fc1c00	8e6360e3-c973-44ee-9375-7c4c36f9e061	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
04713514-71ee-4d98-ad3b-a93524f854f2	19f89650-e519-44da-a57f-ccb23715a3a4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
04d32cac-0f43-4351-958f-55a20fa8cd4a	3d755c6a-1f60-4032-a5b1-35b1237fe752	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
051c82a5-0edc-4e1d-862b-e4ff29ce22e1	2e8fbf8d-6ed1-422b-b297-5d8d49db760d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
057b474e-e514-4cec-b697-b52f7ee62d62	d339d274-4ebf-4049-8b8c-39d4dbf5bace	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0590cc8f-53bd-4de7-a8ef-48f83e95f839	0d8c9c8a-bd6e-44ae-8661-36434ce780b4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
05a9e20d-6ee3-4dff-b6fc-ccc624a3dcf2	f0a7e95d-ddd1-4aec-b685-ae69408aecd2	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
05f15ce1-bf62-44dd-b44b-48a61076ba38	7670b87e-2ebb-42f2-982d-3c7deff7c18c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
05f6ae6d-62d6-499d-9462-229313576a6e	d2788b66-0224-4600-ad92-593bbda6fd6a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0606914f-a739-4bec-9a43-bcca5bd18d94	96191de0-b04b-4106-a4bc-af8f0ae85352	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0623927d-d5ea-40f6-b2c8-62f3e59ef9f4	8d4bfeea-9d7b-4a9a-bbca-422501af77a4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
068de132-e8a9-45b2-95cd-2aab28c41128	7fcd7339-ef1e-49c5-8076-5493d7bcd2d4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
07777c9f-a5f3-464a-8ac5-68c55fb10849	ddc3f6f1-5abd-4760-a6b4-02f23389d543	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
07d9acb1-2895-40f5-9ed9-b8c2dd4e964a	827cc3f3-3c78-4387-aa7e-1c89c31ed44b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
088a6ebe-1e4a-4ca6-9287-be8fd1b05b59	0f10883f-72fc-4cc6-abc1-150bc6751b01	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
09062a43-9fb7-4e52-8f6c-98cb284e0a14	71575290-6997-4fde-9ab1-73b40039c979	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
090dcd36-92bc-42ff-aad2-42f84a707a5f	76344c2c-f1dd-46c4-8939-17646de8b485	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0957293d-3b80-4c49-954c-bb5abe246b27	73729b6a-fdb1-4dd9-822c-63212ba6c4f0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
096f2d0b-3453-4ac7-98c2-1fde15acce62	fa228b43-9266-4fdc-ba1d-e4187575471b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0a3514c2-d151-49a5-8c1a-8a4b3d2e10cb	3d1e8bcd-993e-4b8b-b31e-cd2dca09ab71	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0a3d7850-78c7-409b-9f46-c9457650e12f	4b816608-1efb-472e-b494-fbf986570162	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0af80b3a-cca8-4432-958a-a078c1379d7d	758a9c69-30fe-4632-a367-0a9510a78c7f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0bd81688-7f28-4584-84e4-f7c0bae4e6a9	b89bb9af-077e-4799-8f1e-c946185453b7	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0c8a1507-a514-4261-9a82-912e3fd5e1c0	96ca337e-20e7-45ea-bfa5-b1c3d2d83003	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0cb48369-3462-47c0-a16f-c63467009b39	2485b4de-f4a2-4dbd-b072-d126bf1ed522	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0d60794a-23b0-472b-b976-cf79315ddc97	04ce0acb-911e-47cf-9b3e-b7690d00f8b8	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0d689be0-237a-4caf-992b-0146fcbce847	607e86db-4bce-4668-a145-a9c8a7bbf6c3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0dc5bfad-66ce-4674-9925-deb509c07205	beab2097-78fa-4d03-ad20-f8e19d466e0f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0e18e815-86ef-4964-b890-9c2ff772186f	69ce12b4-3641-40fb-942d-1d4bff8bf997	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0e24dccc-32ac-41fb-92f0-536f5df0963d	c25f41d9-abe4-42c5-b873-5f9d53b32b9a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0e6f4550-dbc1-48c3-a554-89cd208230a3	5bf8121e-3283-4ee5-b1e2-5c4cfdeb5871	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0f1f2f72-6c5b-409b-ba79-8f916154f778	69743912-48f5-4a4f-adea-aaabe8e2ee49	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0fb0defc-a3e2-428a-a5be-4d4698fc9921	36ad1b85-f2b8-4ad0-8f1b-7b9988da0a6f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
0fca8bde-0152-4baa-ad82-967c48cc267a	5eb5086d-afd8-48d7-8956-4025686248b6	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
105fe28b-8d0b-420c-9949-b03900b92fa1	d70d41cd-4c74-4ade-aae6-7144929b5a64	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
10c1d7c0-d149-4be6-ac8e-6f7664ee1ee3	817178a9-b383-4252-b450-fb8ea1384a17	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
10f4c069-f2d4-4be5-88ca-8650a1eafff5	36f75757-9db4-4fb8-8bae-f56852a95d6c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
10fde870-2674-4d3a-97bb-1f70bd3cba70	4111f3ed-688a-4abd-b4c8-8b50869ebdce	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
11216ff4-0a0d-4f3f-b89a-1aeabe15047a	2b8c54e1-655d-48d1-a072-9c9a9fb40ecf	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1194d176-d215-49a9-a710-425c89cbd7fc	5a4b3f60-2101-4fc4-a6a5-2837eab3871f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
12f4dd76-3df5-456b-b052-b0bb74a06553	032bbbc8-9c31-4a9c-bd16-96f28ca52aba	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1361c4ad-123e-43d4-82af-9302e4dfba79	ba5174cc-8be0-460e-9c10-198d62817a9a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
13fa14b3-2645-427f-862d-bdce0179c63c	3c8ad36f-8ebf-4e28-8497-8100f5a77adf	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
15826b35-83c9-4975-840a-cfd2ccacf29a	0e2de120-0a2d-41f2-b71c-0155ed693e1b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
164330e7-7a28-42da-b795-92f8b22f0a7a	69299fb1-ec72-49b3-8fd7-3674482e8f3f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
16a6cf4c-2ee0-467b-b7a3-433679bc4af0	8ac35edd-07b9-4013-94b4-e224968b78be	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
177e1486-a52b-49ef-8e44-8b2d95765dfe	5f43fed8-9acf-4c0c-afeb-dd6abff8d1da	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
17a9f59a-3f6f-4826-9ebc-b5bc4e96f62f	c694a863-f49b-4b3c-a727-ce5e49bf88c4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
17b72a1b-291d-4989-9bf4-c3544e642af1	4cdb0e92-f80f-460f-9688-0a160cb11171	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
186bf3c5-2f8e-465a-ad32-f409ba74d9b9	7c3cf90b-fab1-49a4-9ed9-a748888ea469	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1974acff-600f-44a2-a941-fcea57b3e779	4fcbd489-a620-4b12-8bcd-3165c6babdd9	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
19e207fc-8b07-41fb-95c1-ea3dad094840	dda54e6c-e082-44be-8884-e2611b98d6f9	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1a50e443-2a88-4cf7-8156-62b364251623	e56c9de2-9e33-4334-8f5e-555c4d20ac68	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1b154a31-f1a5-4883-ae93-407a2e07c20a	fb34af88-781a-43ec-9b5d-04eb15a5d1b0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1b4e3b99-d3e0-451d-823b-cf16ff625c42	a282a055-c98e-4052-81f8-097b1f61081c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1c17c4ed-863a-4f83-92ee-ff0de3aa531c	bd76b615-cb07-4368-9f2d-52c6b3cf2e87	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1c361fd8-ec3a-47e6-a5a9-c7b49f7ea1fc	8de4ac4f-1f47-4b85-a56e-7202017a7b99	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1d2a4ddb-0a9e-4dd7-bea8-dc64a8bb69c0	d736fa08-0717-4835-b04f-4cec548f3dc3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1dfe30cd-6d8f-4814-92a0-8371c8f4debe	1c381d5a-a8e2-414a-976d-7d7e6d812b22	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1e4ecb1a-377c-4a65-b5da-9aabe44a0d36	dc702f13-714b-4fad-b386-562beda4c058	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1edc8810-372c-4d68-a9a9-7c7211bf0cfa	5e971f5b-d6d8-42c5-b5b0-24f335d73947	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1f88b8b1-07d7-45e2-8fde-981ce573c794	d2c05d3b-2245-4218-9b84-72f4d0e7b57e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
1fa9c1fd-fc8d-4e5d-b1d5-6fbd44b7086c	e9d5f308-0afc-4d47-9528-0be2597234b2	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2017d2e8-536f-4e26-a953-4a390190ad06	818314f9-41ac-4076-a3dd-767ff7576491	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
20c99a4d-8dda-40e1-92d8-7ed378f58327	a54260f0-6dbc-4962-a24e-fad90d9db08c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
214144d2-afa1-40a8-bb42-5211e6a2939c	7cfef930-ad4b-4df4-bf5a-90d2965694b4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2168d420-3544-47d3-87f3-20e53459cdc4	31136b30-c029-4ed5-bd81-2bbc5b7bf9f8	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
21a91440-0a1d-4948-ab0f-69da8dc0346e	30efca14-6448-4ea3-9d12-7617e4f961e7	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
21b72602-8ae9-4541-836e-d461524738ce	73f011c0-0be6-496b-8706-848fbdfb2b5f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
234c8afd-55a7-4b40-b94e-5c642d5575ef	6d78f254-4d4c-47b8-a8a2-847323af0303	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
24416f87-b183-44c9-bbc9-5edc51da10e6	e273f84f-b9e1-44f9-a835-0c5f02c471be	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2467917c-49ca-4f35-ae29-9cf596793914	ad95f5b5-63d3-45b5-8176-cf300b28a05e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
24b806f9-1488-40b3-8a53-b5d2408c5326	0b1e4421-19ee-4f01-9977-e2e3ef7a2dcf	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2676d3f1-9357-4122-bba0-6a74255496ac	0ee43e2e-f4f2-47bf-9b49-5358b1dba4f3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
268fe5a2-2089-4772-90a2-ffc8641521eb	f262c84f-9de5-466a-a321-82736de980c9	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
26902b1d-16de-4009-aa53-1c782b1709d1	7209f59f-9429-484f-a64d-9b3828c9da84	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
27957d60-8514-4abc-9c2d-d5035ce5bdf3	f722b76e-0bbc-42f5-86a0-9eb621427888	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
28eb178d-36b6-46ce-9629-dcc8e6996d09	8eccaa8b-f125-4a7a-a149-ad22abbba613	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2913f569-6c6e-4c15-92c3-022869816913	99e3899d-9f18-4be3-92dc-c86211ccd7e2	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
29687c63-0061-4c9e-87a9-8ce9c7681587	9446d7c4-cdd2-4be5-ac62-cb9960cad1e9	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
298ec062-dd49-4f5f-940e-55a459447d46	73707d27-e5df-4527-bac2-d1aa00963356	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
29cde37a-4ad4-42d7-8a8e-1d3505b6fdfa	69ce6a56-e322-4f1e-acf9-457c8d9e7ce6	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2a9a2be6-e055-40a2-a69e-5def8c0e687b	5eccfda7-e2c9-4723-9d00-ef37b6416bd3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2ac8e7ea-541a-41a0-8399-cffa2e054e05	f7f447a0-6c28-4078-ae49-6f802ccd1720	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2b2184e7-c233-4b2f-9e88-6419f8ff29d6	493f4543-d6e8-47a0-be3f-2d47e68f435d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2ba64bce-cc77-44aa-9e0b-cd93a43ed933	6823f141-689b-4a33-b878-265a21e279a3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2bae9a49-5dba-4de4-af74-2dca4ac03b99	f8e5bd2b-8c1d-43bd-bc4c-d8942b78f251	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2c9a25a3-17f1-4a43-9af3-056eb5516436	86e76471-25d1-47a4-8720-87764be9beb7	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2cbbb395-e428-484f-bd41-67c93817169a	53f28ffa-8f47-4918-b58a-ee837c2a065a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2ce413b6-2030-4c76-b3bf-955e44e3ab7c	7a724f0c-9f16-4632-a87c-5b92b5a184d0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2cf33f3a-9bf0-4858-822a-b017fbe4ced5	0b3cd112-5c29-4f6a-a632-4e1afb08b2c1	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2e844a51-e033-43f3-9850-2df4388619fd	e52c22b6-1850-4873-954a-8bf2090ff768	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2f9fcd3d-6eed-4a2f-9d9e-d1a02ddff90e	3c398f01-914b-4654-b2ff-2a4d7187be45	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
2faa4809-444e-46ab-a7f4-a0614d342798	d80a1589-8edf-423c-992b-17e7f3a2618b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3167e9e6-4555-45ad-ab06-f4d26a10e41f	5feecb0f-0c9e-4b0a-ae2b-23281718131b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
324c1a47-32de-437c-9827-36c4a3c0cb42	fbd387bb-e2d9-44b3-a8f2-128e65bf5e07	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
324dc3b3-ad10-4b1f-9c0c-5378330aa2a4	c1827ae8-b659-4968-b518-7bd87d328e01	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
32d6a3e3-372a-43a0-980e-5a137962bdac	7cc44e4c-295f-4222-9010-3688c1a6f35e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
33a1d731-0f15-4cdb-99b4-eaebd187ffe0	3c1226aa-01d5-412d-886a-a26293866431	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
33ebe985-8717-4aea-91d1-492e8cd9f688	5d2a72e2-90b2-40ba-b5f3-d32f4790acb9	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
33ed2ebe-d6b6-4ab6-a1ba-079233362485	6d9a8c1e-778d-4043-af7a-8914554966a2	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3406ef4b-8437-41b3-bad9-55b24aad7ec0	b852b9dd-05ea-4462-a76c-270eb7477de4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
349bd44a-a9a6-4ca8-ae8c-22a608acc13e	3fedd13a-d120-48fe-93a6-18e2ddc9124c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
354da3aa-7443-4646-a860-e7735c30e5d2	72169d59-c215-4bc0-93ef-b00cfab2547a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
35c426b6-5569-4cd6-ace8-e93ab0e3e8c5	5d8f5108-449f-41f4-9c37-0920ecad1915	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3677ee97-64a4-48e3-ac03-f9ac7e7893a4	78195f92-a240-49a8-b370-c54834738f7e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
367cb1a4-6920-4315-8b86-5095c159a235	d3337bd7-2312-4194-b5ca-baddb5cc7034	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
369639bc-dec0-4bf5-9a83-7df3d9cdb6a1	0531df44-bbdd-4634-b5e9-4683e9685511	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
37c9c2d0-540e-4a2b-8bfe-add140833bb0	2aaa061e-376f-4ede-be62-7043c4bc035f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
385ab10a-0e39-4263-98cc-b30215c82160	590a7adc-abf3-4228-a178-c0db16949848	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
38cc8265-5ce1-48d2-8064-7bb83c362fcf	f2a5c2e3-87b0-4c12-a545-e73daedb3044	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3a30a198-d047-43d3-a91e-cb384d422ed3	02dc8906-f417-4944-8f53-48eeaac0fb93	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3a330ea5-6e83-47bd-9bbd-ef4889cfc61d	a23b65b5-404b-4e1c-a26f-cde72111c245	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3a5081ca-816a-46d3-8f40-66641d534bf6	616052bb-ec17-42c2-a9bf-71cb972609a6	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3ce1223f-34fe-4c46-ac32-e6a254db4432	d8faa4c0-5943-4c52-a0dd-51435e78a629	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3d1dead6-b876-4964-8a9d-be7677d2df8d	ad54ff08-4b4c-48ca-b770-966f6e5a5577	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3d7aa277-d0e5-4036-b037-c21f0fe37230	d9bbd15d-a3b7-4b7b-b037-aedaa4a534f0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3e171df7-0453-4c61-8672-d670fae29f91	e0fa761b-311f-4a95-acb0-65198f5d375e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3edadcd1-8b79-41bc-bff4-d776c45c37bc	e0b66c7a-a24b-450d-bc80-94fbdc45eaea	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3ee25234-35eb-4b4a-84e1-74cfad5a7652	9ed392f4-7f4e-4f79-b4c9-dafcca590c7a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3f5faff1-3bab-4ae5-9593-16d1c16bb8e1	ecf349d8-5c52-46a6-9bb9-3b21b74e3fd0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3f701110-4b45-4774-8bb7-f8e543116fee	742f4b5a-e249-4864-8d25-6cca40dcb7e5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
3fcec7ef-0aab-42b2-be12-42a4b9504dab	62fd7cdd-019e-44a8-8f51-2d87e3f84574	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4000193f-0dba-4e4a-809c-04c2a63e1d28	4a8d42a6-7320-4cc1-96ad-6f6cde8be9e0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
402efc0e-7dbd-4ba5-86ed-2cf452317ffa	10276352-0e53-4e6e-b32f-254aa7e8ae44	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
40a8b0a6-e79b-4e0c-99f3-e55ad674e440	eb45bcba-5fa7-48c3-8104-6a1d79368f71	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
419ef1b8-a8ef-48f6-9474-89b9851ba6f4	affe9aa6-6397-4b10-9f18-01b34dab38b6	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
420e3c11-fd3e-4c96-97cc-3a22f236c2b1	cb529ab4-fe25-4824-aaf9-d0dd0172e2d5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
42284616-3db3-4eb8-a031-bf587d7b4bb1	953bdbba-2b4d-4896-882b-92af8a0cea85	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
423d06c7-379e-49e8-94d3-1da9ea492692	16ee5481-fc68-400d-bfaf-0b6d60f5c40f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4512bf37-dd40-48c9-89a1-944563880363	4d956559-c16f-48a0-b961-cde525f97b2e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
45b89bc6-d9d4-48a6-8247-f072e57d39f2	b6ee040f-7ae2-435c-9945-bc928981af0d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
45f293ae-bae2-4168-a365-9f5e7716eeed	78f79366-a79d-442b-bb10-47afbc417569	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
467eec64-5532-4517-a6a7-700b5608ca9a	13640e96-4e7f-4a64-ab70-277c49298e79	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4753ac15-c53e-4289-b38d-3e90a7daf97c	60b038b0-4e06-40bf-90e6-b8a5b72e514f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4794ac6a-bb13-45d9-8976-b715379922c5	aede4e6f-e67d-4b57-a4b1-ab059af15f62	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
47c5aac4-5955-4c02-abeb-86762c223973	ec206af4-b9aa-4903-bb38-dd6a8e5417bf	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
49330aff-717b-4186-a278-ce1f25d354bd	4a9de1ba-9f24-4c3d-b360-1531cc9219a5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
49397001-a4ab-44e2-b330-e2e0aebb4fcb	84c8bcf9-95dd-4dc2-9ab6-f4c2c2978f69	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
49b6f5ef-e769-4dcc-9f21-57b7f6f1cff1	e1c41720-4e7f-4089-b991-8716822b401b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4a06a18b-49b1-44eb-bb3e-13afed794273	f239d1d7-9ae5-4b79-b202-61370c264ab1	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4aef25e0-ad27-4d07-951d-0822d5999f24	eefc111c-1158-4461-8f58-970b021446e7	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4bac38fd-c084-4160-b424-b4d03672fe10	69de0e4e-6dec-4ae3-af17-d08b37597abb	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4bbd6893-f29f-44c4-940b-5fcfb8c29a91	b254302b-b94e-4a1e-bd80-bf8809f64ae9	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4c04f301-587e-46af-82c5-6d517cfb73ea	a50e7171-8d68-4b37-8cff-336e262eb54b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4cac8512-f600-4e71-b8fa-fce9b89fd08b	e68df09f-8a4d-499d-8095-95e70e156dab	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4ce9c8cf-4a39-4778-8a29-6784cad33449	96380613-e3bf-4d25-97e6-e02fd347217c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4d04915a-ea2a-402f-9faa-0248cdf4cbc4	4d964775-64eb-49a0-9e31-c4e9f4c4ef47	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4d31ab4c-36b9-4c2c-af2a-a64889e2ef72	e53be42f-7bd3-4696-b5ea-23a5a0852c8b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4d6b8af8-cb05-4d5d-8d03-ee6af72ec207	f3c3f4d6-80e1-4097-9aa3-9cd58a8dcf9d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4d8d670e-c944-40f3-930c-c99331271f0b	f385e595-c77b-4456-85f4-b7521c3adc82	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4e095193-2945-48ca-9bc6-6ea3be9b9d42	01e9894c-3f8c-4dc0-8725-74786e1f578a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
4fc06b6e-bd39-4a9d-876e-6e8b71e470b6	5fc396c7-d6d7-4025-993a-37980e22ef53	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
509a2599-7de5-41c3-af4b-5df47f8344d0	b2e4ebaa-5732-40f6-9a83-b82d1dd3e9ba	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
51686936-9fc3-4e65-aef5-949675d41bf9	5e8ee138-b7b1-4503-8f82-cd70fa10bf33	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
518abf37-c491-46aa-8247-fba1d1ef0371	fda13868-16ed-4f54-8a89-b7facab5be53	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
519bbfee-7e9d-4e90-bbb7-f513e62062ef	5f9abd65-4015-4556-80b9-a8158ea8aff3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
52e79b74-9f4d-423f-9544-cfb2594a8c9b	8afd5524-44b8-43f7-b881-9577cd92aa9d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
52fe7115-8822-4a45-b25c-4c40b9017e84	37291ed6-1137-466d-9acf-a3c82edbaede	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
53d391b9-f51d-4978-a9c6-778d80b93010	e60f4586-f7dd-4a25-8840-d41a73f164ef	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
541f2945-2012-40d2-b485-be65b1160a71	0851307e-e5e1-421c-94af-feebc0e5ca88	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
54aeeafd-02fd-41c0-bbfc-7844d2f15bec	e55140ca-be71-40ba-be28-e2a82bfb9a8d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5661951e-11a7-43e7-8a1e-220d4a1ff707	4b73a9df-d4c0-42d3-bd1f-ca46645a7c8f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
56b0783b-1b30-4dfa-a6c6-166a999533cc	00b21956-0e1c-430a-b3b0-f301ae5c8034	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5823db8b-d46e-466f-a31e-f52ff98d72df	2ce9b03d-0b00-44ab-a660-c2880efe0a5c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5a44c018-7bd8-4683-abaa-8c9378f695d5	5af12322-a94a-465c-8d1d-dc4280b480d8	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5a8ae328-adf4-404a-827d-0cf9d1d323fb	dfe3a7dd-f129-40c4-a653-44dabe5592a0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5b8e51b1-bdbb-411e-b583-eabbc64c55ed	a0fd1d26-9a4e-4d5b-a8a4-c7af00deb8d3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5bbe9042-2d65-4753-8261-a149a26a0df3	56d3ffcc-1cf4-4cad-8f58-e806262e0632	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5bd3b77e-d4ed-4059-96db-41c3e4e2f941	1403be59-f42f-48e7-9552-2e1719f1b909	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5c282f39-faae-4600-b095-3217c7638b18	88418e20-c4a5-4c62-92a1-61cb4a2cb38c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5ce0a35f-20cf-451a-868b-7afab891ce75	4c09fe87-2332-4258-b2db-6f4231dfabaf	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5dde97d9-34c6-4863-8149-dafebcbf1091	7d7e735c-342f-4cdb-8f10-ebe2e4129d18	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5e131842-58bc-4d15-8b67-34ab5b93c93d	28de1d51-e45d-4ef4-941e-90ace493ba67	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
5e73dec0-8048-4eda-91be-d6bb6d684f18	f1eee410-31e4-4fdf-91d3-ac04999bba18	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
600e8316-0295-438f-9995-3acafaf99385	3ffc1f7a-54a2-4244-94be-5a34b2238b96	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
6022397b-1c17-44b1-9a14-6271adcc7b98	973fe404-138a-4636-9302-cf720f33ecce	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
602a93c4-03b2-46a7-80c8-06a0f6a70c05	d0d5b935-3642-4627-86b2-5b37a842a730	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
60e33e7a-b431-45f7-8ff9-43788361a9cc	126e2196-84ba-4cc1-a178-b636585aae6b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
616d0d77-659e-48be-b5ea-24bdbade8e93	0e6ee047-b636-43ec-9fad-9f8f46b6a4b0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
6186a254-8d38-4b17-abb9-a3045a922bd9	4a5d180c-a20d-4024-8d52-1137a9f0486c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
61926781-3a75-4c59-b3df-da7780b86023	cd04a9ab-cc90-41fa-b25a-36babef6765b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
622550a0-699a-4a2c-b885-bcde4b6805c0	5a2b1917-f8ab-4d51-b728-aa1ab1f89181	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
6227a8dd-c168-44b0-abcf-fecb283caa24	33756a76-ebfd-4268-82bf-0a44137c792c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
62cf1e9f-17f7-4e47-bb64-5fb0d820748d	b1e9df5d-55f7-4f1d-89c1-29a0ff80d2a5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
63ed4585-975b-47d9-a0eb-031df6e0854a	b6009807-c8bd-4366-a4df-4a39b0886a28	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
641f3ebd-0f7a-4955-bdab-bc568712a759	719d5dfd-9a22-42f5-90c8-6cf3ca64d3a6	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
653e6246-b24b-47fe-a083-e9fce9df72c4	9a7932cb-7370-469b-8cbb-fd75361d2000	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
65a76e09-9d90-49bf-9c33-f87f992e1a3f	ccc7b344-9b8c-459b-9811-ff4add2b8f96	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
663feaa3-6a74-4ab3-99d8-57dfb1cc65c7	bac94a08-f433-40f2-82c1-70cea2082cc2	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
66971503-8c1b-42fe-8406-76df6876f134	484d80c9-092b-45b9-a398-e78c86acdbbb	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
67088b8a-c3f5-403b-ad67-0cb18343c25b	e47ae315-381c-435d-8316-a6a6ce07dcc1	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
67b0c003-1fb0-44fb-befb-55282c8e512d	123ed5a7-f408-4292-b4ba-d7920bdd6b28	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
67d237bf-6ef4-47b7-801b-add7866baeac	369b89e6-a74a-4aa0-9adc-7ffaab56f103	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
685b8beb-9101-45b9-89cf-6afdd5236094	3acdda56-6bce-4569-b6c4-f36132d9aee7	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
685d3d4a-7bb0-4a3d-8910-4498dc518e8a	3b49ea5d-d572-44c1-9d57-8ae6b512fa12	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
68a189a5-49ab-488a-a9df-0ee041de92dc	643fe4ee-1d84-4366-bb73-f3f394de0c60	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
68a95ade-f93b-48d7-b118-8fd298429621	b9e623c1-07bd-4526-9a17-e9e93e7b2e8d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
68eaebf5-b5fd-4bc5-be52-8faaadca1a6d	47c574ca-ab35-4845-85e0-285205012ca4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
69132812-2f28-4b12-9ae1-0f5c04063f92	72ed15e4-1128-4040-9bca-735390031692	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
6a2c15e4-efd6-4188-a589-9ed0488b1e3c	3ae9b60c-2e0a-49a3-ae36-5d55e74e817f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
6bca1a9e-1a80-45ef-92b7-c70b6133bbc9	07a0400c-a511-423a-b63c-71401bbf60fb	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
6bead7e3-1da9-4a2b-b0df-ffe6e0de432e	90561466-4ef2-436f-b3d8-a563509578ed	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
6d31595d-92f6-4cf9-9640-f4fc3af55a37	b435387a-67eb-48ef-bdc5-e452efa25dbc	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
6d5cd8ad-d283-4880-bb71-3f32b83f3ec2	711613ca-2d50-4a72-a90e-7a018baff791	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
6fc7bda8-1903-4c0b-a5ae-9e43443d33b0	593b64bc-d5f5-4056-91d3-a741c1d3d26e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
70f22499-2689-4858-ac8a-16c92658ac5b	d6e0a747-2889-43b8-bc9a-c11644d18404	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7429803f-6947-45d8-a629-ad371affc177	61161a73-a8b4-41b5-bf43-c41d7790cc50	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
74564a0e-debb-4b65-919e-98d58dab4756	825f43ff-c154-4d35-b742-5dd30f0fa16b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7493bef8-8569-43ef-9ebe-1e55d26e4dc5	406f1880-6042-470d-a17e-3f95062b8489	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
74e34e31-baac-497c-9ced-b1b58ffc2335	2b7be4cb-3877-4192-8dd2-f9bbe62dbe55	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
75b2b079-5876-4987-ac2f-774a0c59d5fe	98a2f40f-8c33-46eb-9e6c-714fa4e47c44	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
76331ac5-e67c-4782-acb5-8832cc24e3a0	694dafe1-1db8-429c-987c-ce4d31298649	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
777e552c-777e-47ad-a4a2-90e3814ec75a	99316f9a-72eb-4c2c-9954-bc551d1c87db	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
77b17da0-0de9-4ada-ad9a-d814f865c8c9	28afeeff-ebb8-4585-9319-8731e99b9f1a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7802ce5a-a1f1-4a5d-b99f-f2662a634a28	2be0769b-fbb8-4802-8961-75dbc0f0d423	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7824174c-baeb-4ce8-a79d-7a02ccb9620c	5b101808-929b-4602-a113-86962d06e021	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
78446dea-3d77-46be-afe0-70cada289135	9facbecd-271f-4d4a-bfc1-fe9a85877f39	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
79261bea-21f0-42af-992c-5bad5f908730	0818e0c7-efa9-4629-b900-3bac6b292c3f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
794d3abe-870f-4477-8959-a5524a500412	358738bc-b22f-4a7a-8a35-b9cf1e69a504	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7980a145-a7eb-420c-a647-0c3456020c29	35f2a3b4-afc1-4bbb-a589-c754871ad962	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7980c3e2-b28f-4f97-a832-4490d4ea53f8	f896854a-a680-4758-85ce-5b49a38f84cc	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
799700d2-7fec-4478-9637-869b4d2c8917	f7ee32df-f774-413d-b51b-910ecc6b256c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7cf5b531-7586-46e7-b480-fee4e2aafba3	85435a7b-e93b-40df-ab85-872091554f54	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7db4b07d-3c27-42db-bbf8-1712052b1412	1a33fdeb-aa9c-453e-848d-82780bd2ed82	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7e52e24c-ab3c-4949-a6c0-d6ddb128039d	b85c2dc7-6e72-4413-93a6-acebbb845916	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7efcac6f-d202-4322-abec-d2c0ef593f83	f8bb80ba-0ded-4f44-88e6-fc44b2527769	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7fc6c3a0-dace-49a9-8793-7a687cc8ac52	ef48d4df-6d34-4b01-b862-b8b4d985b8ff	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
7fd6268c-5b14-482e-8fd6-6834c2280c63	55f72234-28cd-426b-a23f-4a0f38e701e4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
80354ba8-b26a-4e7f-8880-5b9a29a9ff07	4777cd9b-81d1-4be1-be29-ffbb69a4aa37	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
80358a0a-bcaa-4fbe-a677-a31a1062a122	42303f02-f809-4fdc-adbf-c3f590655747	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
80881c66-36a6-4114-8a81-04b62c877ded	cf40c5e3-28d2-42de-aab8-cc116bd14c03	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
80bcd196-210b-4c89-b33a-7654ed1a74ed	706c521d-e24a-4e4a-a811-69fc2f3b4e2c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8180bcdb-94c9-4889-94f7-44c3598e5bcd	81ae773e-088b-4ac2-bfaa-1de1f8457888	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8260315d-1288-4304-b75a-a17de927647d	01ac974c-5fed-49b4-8186-2a47ec1154f4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
829a35c7-ff71-4f7a-ab40-e2fbef2b564f	bbf3bf6a-1f87-4c62-89d8-e637f8876df0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
82d447fc-94dd-41a3-aa1f-cf8edd74eb6d	0e778d35-4327-490d-b59e-8978aa1ca57b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
842c1360-c22e-4b47-9a48-7a57df6fe9f0	0aebd6d4-ace8-4d66-b33c-b71009b40b5e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
84fbd281-2358-4540-9a5c-a3a31986fe32	f2496cbc-71a3-4971-a960-38e43f3abe2e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8514cf0c-0fe3-4b8d-9d8c-640a50fb9891	75137c2c-b141-43dc-8861-1f3ddc768508	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
853bf4bb-32d1-4d5d-8c5b-fa7b13f38de5	3327f3ad-6d0a-495a-8727-2e7e41495efd	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8567e8dd-951f-44a5-b62a-2da65147e863	0f21feb0-f821-444f-979c-7d139896ef41	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
86411261-e512-4152-b75f-8127e7b0a254	593e8264-f9e6-4d96-a107-677c6195e2a0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8674448a-ad86-4f47-97e6-6a2d1bb0e83b	e3cbd2ef-86f2-46f0-a24a-34ec1e2402de	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
876c1e5c-4798-452a-9982-df61fc58f148	d36c42f5-09ff-4994-b7c8-9db5ebc8dec2	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
87add5b5-f9ff-4a79-a59f-ddb1a1520ea3	941e94a7-7c35-4a81-8502-c64b1c8f2bf1	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
88331dd4-3861-474b-bd40-abc3b2afdbd3	2d6c0b05-8e76-4ea2-884a-8bf11697e4a3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
88b0dfba-0cdd-4407-af5a-27eec76bc23d	43787a47-4fb7-47e4-8926-a7eb4ba63183	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
88f537f3-477b-4dfd-b2cd-c096805916bd	2e8980af-dc52-4019-b5cb-240e20c48c1e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
898185b8-3ab2-4512-8b3b-92e5e8d2616e	236d7e90-3505-4941-a1d2-5b3f9a77b064	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
899f7e14-c69c-4677-b035-1d445e9faae3	8e790b84-f89d-430a-9c72-48e8ea0ea29a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
89fd0c4f-431f-48a9-8b74-68409483162e	7e80663f-307d-40cf-8b36-52419e3531f8	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8a1e7bd6-28a8-4d32-b4c4-7b7ef2cf8181	9931641b-e9f4-4ee6-ab35-e3a0dfb32d45	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8a7d6846-cbe1-496c-bd6d-92a135a8e4ba	80eb9a93-6eaf-4155-b684-9a7ab092a3ae	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8bf12e1e-18c4-4e6f-a0d7-2e06875a4d17	0016e09e-1d85-49ed-975c-4dfc9f6d31ee	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8c062be7-c386-486a-9174-22f271f2cd59	6df44e82-d5b7-4908-a8bb-c52751769e47	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8cb8e985-221f-4b4a-9669-ea1814d63204	0923d818-10f2-4e2a-b673-2cc54cff6c9a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8cc784b0-2e5e-4bb0-ab98-980de9f8de48	e38cf5e1-3d09-475c-97e9-eea1327a0360	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8d3927d6-c9da-4e94-80fa-562b410a46c5	b1c8c0b4-9f77-48d4-9684-761e637681fe	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8d940592-5128-4ad2-89cc-ef07e3be9e75	eb6f4029-1471-4e20-a4d1-9c8a7e1cee5e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8e39b28f-a917-4d14-af7c-a00f2604478d	bb439488-93ef-4cd4-ad7f-9e4a35769e7f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8e85b7c2-330c-48d5-bbb6-d74116654ee6	e5546e72-d56f-4f70-9d9c-f3361b650689	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
8f2964c3-ca6f-40a2-aea1-0ce18df9bc17	847126be-39aa-4fb8-a293-64ae72d22b14	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
90112d1f-f653-4b69-8771-04c6fdd6315a	f3da57f4-a0b6-4219-8f9d-c481d30e91dd	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
908b15cc-7f4f-412d-973d-b504191ed80f	a50e9dc1-92f5-4c22-9dd3-3cccf1ea4322	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
91f1d92e-e274-478b-87d5-8604e8e63cfe	3a3d4cf9-605a-4f86-9221-319201c9e4a3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
944ddb27-4f62-411e-ae20-fbbf4017583c	9505d42b-baab-4dc2-a0d5-72cef8fd3215	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9531cb5a-7225-4230-9b90-5572fd6ed608	9fcdcb53-eef7-4b64-b100-f0f3f837e16c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
956ec432-a9ef-44e4-9dc6-3abbc9baa415	3dd96ff4-6fbb-4fa2-8333-4148b2ca92d7	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
95f3caa4-1b2f-4200-a970-60c03cd76b56	68faf6a2-04a3-402d-9ffa-81bb60f7c9fd	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
95f8d46b-2859-4d67-b3bf-553ad4a1f600	0bb28ee1-ff17-4ffd-9f49-25818c4ccc9b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
968f945a-e686-4218-8281-653d66fe577e	2fa53fcc-167c-485e-8732-75edf463983b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
96eb4cee-2839-487f-8a6f-54c59ead3c83	1ce422b8-0e3c-408f-8989-5dab23576c1d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
975c4cdd-3cc6-4e4b-9bc9-fe319ffcda53	bfdc274c-b6b9-4838-bdbd-e1f4a33c88d3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
976c8eb3-708d-4868-9b83-e85b0b9b1970	5bc8ace7-621e-4ed0-8ee5-d130a3649220	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
98a88b52-7cdd-4e79-bb9c-b28be9b2cd36	a8cf0fa0-3337-4da9-8bd2-724be25a419e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
98c92026-264c-42e1-a0e0-43b39f5e2d2b	e553fb7f-9b1c-4d2e-a8b3-53d039606a2b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
98cdfc13-ac4d-4137-9680-2597ca772081	3b6de845-4bb5-40cf-83bb-d6ced7d94f02	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
990ab31f-e9b4-4b20-a3b0-288b01bdeaf7	a57f8d45-c3a8-4a5e-adcd-cf3a15f664c0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
992d15d5-5c42-4e98-b78b-4747ba92d7c6	6c085700-9abb-43f0-8032-7a2d1ea9b775	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9934d6c5-975e-4e6f-84c6-dd0aa7801f86	5d53ae38-a645-4d6e-9841-353203d0f19c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
999e13ca-4ed8-4e2c-91aa-1174eacb8d61	2939eab6-5bee-47dc-91db-1a20b330d606	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9a9e7a21-c5b4-4721-91f3-f7e727783a38	864b64e2-9009-41f9-99eb-7eab9611a6c4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9aa02ea2-3280-47cb-9f3a-55dd7664a26b	dc7143b1-4fd0-41ed-b03f-5b33d1f9b2c5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9aec2d00-69db-4e42-a51a-df74b6db6bae	6aae1c69-2d40-4bce-9df6-877768200001	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9b096007-173c-47b9-afd3-3d5bfb395434	35d53330-433d-4883-8919-9730ab31afa4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9b464d21-a6de-4bf4-89d3-dac20d443d0f	d4c1cfeb-6222-49cd-b987-dbd3b1ca2873	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9b6882fe-6984-4e9b-93d7-41e5e405742b	a721bf6a-edfa-44f5-b28b-2c93a2ef9585	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9d842864-5d49-440c-a220-9e2d4aa3a626	c2477c02-14f8-431e-a586-097ec93c9969	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9e276375-a307-4489-9ef8-e91c078931af	c50f6086-3717-4653-be84-de8139e8d6c1	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9f09f8f5-f6ca-4b50-a213-7f8c0443ab3b	ab805c43-240b-4f58-bef2-b4a9c5c8dc48	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
9f6f66b0-7692-4f9f-a82e-46aca7abffb9	dc7a9064-88de-4a0c-82ed-079f140a54cf	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a013a482-8ccf-446d-a248-7fe832646854	0c05ca66-b8c7-471e-b562-bd86f6076a18	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a0db7599-d298-4382-9b21-242b38143f19	68d56178-e5f3-4a9e-ab9d-3c6c6a8aee13	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a1219587-14ae-4933-855c-270c1ffc70b8	73309000-d3f2-48ee-9297-a26e9b777506	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a28e9122-de81-406d-b485-fcd65cd8bd22	5fe9881e-7563-499f-822c-06c10edde4cb	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a4acae78-79c3-457d-9c8c-bff32924eff4	6450ef26-6a76-447f-928d-0d75eb7b7397	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a61b8dfe-1498-42ab-ac84-54d0f89f3242	4960a642-cf3b-41c7-9072-21ef1a03e377	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a623dec7-69c3-49f8-b13a-498e6b6a04a2	e3676b44-c66d-4c26-a94d-cceecaa0be44	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a66c44ae-4765-4366-b346-6e68ccfe0956	91478ccb-f283-4bca-94ac-bd3700fafb7a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a7fe8287-7f4e-4423-8813-bc43ae841bee	fbda01ea-d838-449d-9817-954717429eb6	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a833f518-a397-47c9-bdab-2412d9b3cd92	53fb6537-0c03-4fd6-8267-18c069ab99ae	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a856aa41-71c6-4406-86ea-129e9983b97b	89ca7e37-d3d8-457d-98f2-b4c20657587a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
a915c5f8-82af-42d8-ad93-a62917238f3c	8a38a878-9539-4ec9-b3c9-aef5874297fe	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
aa75780a-4a11-49e9-9fb5-8d906c9775bd	3b95fbb7-49a7-460f-8f78-c26dfdccebec	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ab086bfa-e1da-4178-893b-208ac00a583f	019ff171-4894-43d8-b3c9-048a5b456a69	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
abd4cd8e-4a6a-4381-892d-d67ffd55d998	c1688351-a5b2-46d8-9397-5d8398fa713f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
adc4d3a5-3750-4dde-98d9-dae1fce37a44	5bd9133f-7d8e-48d1-949a-b70f0bf8ab1b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
adfbd345-61c6-4daf-be96-fe1f4082c6e8	efb82d7b-7d96-4f03-a436-8d61b0592528	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ae654fab-7e1d-47e6-bffb-16f82e1b3e1f	8ef663e4-545e-42d4-885a-a61babd7f7bb	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
af1ea847-b4eb-47e8-bdc7-7c6326b30178	269870c0-ecf6-4032-a227-0a0a49b45a65	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b0bf0485-7c13-44a8-a747-00230071cef2	26fd855f-9d56-4e39-ad17-3158f1b95d79	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b12a5d66-07bc-4169-bf1c-71426bab70a6	49947184-23b9-482d-834b-decf990d37c3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b19f23ec-482e-40e2-a827-b331124fb04d	face0c5b-b7e7-454b-b87c-31e7ac99b486	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b1b3ce21-bfb2-4e05-8b79-c69a8caad3ab	eeb7f5b5-8e33-4ded-b491-6276125ba1de	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b238556b-820f-469f-9311-9ef6dbfdbed7	a9c65ccf-47f2-4083-8a0f-4b62af502b68	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b26713b4-8908-49ec-b504-136d586f12e9	aea15717-ead4-4a3e-bd29-0a313cbe9a10	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b2b18d4e-75be-468f-a9d9-c445a396be99	1eff1bd4-0e08-48b9-a2ab-e7ddfd6b1731	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b3196b89-1d3a-470c-b741-c92e34dda497	d45cdce9-8250-4fd2-94d3-b81c6aba45b3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b39f871d-5918-456f-8366-8a213b66fd03	a473c34b-6186-48bb-af6a-d4806ed2fdd0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b40aa464-73b8-4a0f-a566-23114563ef0f	f390f37d-7278-4585-bc86-d32acf68f2b1	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b4a92c39-113e-441c-931d-3c90e70a69ea	d2ceb872-55a3-4c64-9ffa-9996331e1e3b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b62ee0ad-d9ad-4680-b5a9-ec51ec208cc0	2d7f1580-6089-4ae8-9abf-8ab6be102587	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b6bd0949-1858-467b-af02-1acdef243447	cf912b1a-f1ab-4c5f-bcb9-b0b5edf912fa	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b724f50a-8494-4a8b-ae5c-ca9618e222e5	ec616684-531b-4e0f-b1b0-6fa518e03fcb	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b914787f-a35a-4361-895f-6d33edbce340	17b196e7-a5bf-4938-8bd8-135d52aeab5f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b93178fe-da92-4313-9fe8-bb996cdb0814	691a8cda-9583-42cc-ba0e-ce0d0935c110	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
b9998a2a-48c6-472b-9884-37d834d04a69	a01c7451-46a1-438d-98f2-2db6d9402c24	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ba277a74-efb1-4f1c-a0c0-355c43bc35a4	5e3a75c5-02e1-47a7-9dd3-50560ba9f5f3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ba7e7906-cebc-4482-af42-de5b1ef4719c	5375df11-bcad-48ff-a25b-48f02a8ce699	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ba9a5aa7-bd3f-4693-95a6-0e9d116b4388	2891a422-93ef-466a-ba9b-eb50ddfcc91f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
bc557012-475a-4481-8676-d9475911efea	a531d510-f9d5-4810-98cd-066b395b9abc	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
bc7f5eb5-47e4-429f-8e51-1275af63b772	21efead8-e296-4758-bcbe-79c2c3ee2598	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
bc9af444-470d-4d05-8c5e-ff68ffb0c695	ed486305-966d-471a-99ff-58024653706d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
bd386d2f-c169-46d8-aa70-2542de812f88	ce07cb6c-dd7d-41ba-af7a-85e5c9bc8329	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
bdac1edb-f15e-4974-a0a9-d2d4be7a3920	1168e948-58c5-4bd9-a976-84cc1da41434	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
be8fe526-a464-47a9-956f-d1cf2faed5ad	b2be8018-5a40-4755-98bb-858f6af65e4b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
bed08fe1-81f8-4e7b-8db7-7592c861b1b5	8677d703-ec78-48fd-ae23-0705460eb04c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
bef4502d-5abe-4130-8748-bc14aede87dd	02a56e01-4495-4984-a9c1-5d942bb3e12e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c1446a93-b16d-428e-aa46-6cde07ffc145	b9933d0c-cba1-4a90-b224-ca9ed10b1ce9	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c239ffb2-21ba-4823-a3e9-3f7328b9f4ba	7c479a2a-fa8a-4df6-a575-8e10b9cb8629	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c31f9733-1ec7-47f5-82f1-0d7aaba767c7	43cc142f-bdd0-4fb1-852c-9ecbd3550c9f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c3ab7dcd-5d8f-457e-9dab-f33eac17621a	e5a0ee2a-2097-4d1f-bd7c-3a3d432317f7	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c3d2245b-5604-47c2-aefd-18c755efda29	81c0c8f2-4527-41b7-a15c-997ffa9102b5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c3fba86b-d16b-4fc6-9edc-ce875375a58f	bd9552da-aac8-4462-97a4-7bed797c43cf	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c4422b21-8404-4ea0-b7f9-3c1e768690b1	1d8d616f-55fd-47cd-ad82-f650235fb17d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c4491189-b923-4eca-94aa-45dfb70fbc40	f85dfa98-943b-4576-84c7-a314f4dc11f3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c52be665-74cb-4cf7-982d-a134adb55934	d7a4bc94-15c1-495c-acdc-82c603abbf26	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c56e20a7-12bc-4bcc-98cc-61e6460245f5	9d616eec-4d04-4cda-a5e1-a1ae4ae37efc	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c63aac44-c1db-486e-826b-ff9abbee0765	03b3a4a8-1fbf-4b61-90ae-20714380ab02	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c6fed066-14d5-4c1b-899e-1ad22430e14e	682df2f4-961e-417d-bab0-6fb1838a8853	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c7628f57-8d06-4371-98cb-52ff14f5b5a0	01dc635c-0f95-4162-b58b-c13b2de83d28	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c81a22da-fb09-463a-bd37-3493b31a51c8	73923dbc-5bb9-4ec3-aa69-b81f8f1fa7b5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c896a93f-9199-4be6-a030-b5ae774623c1	df4ca97a-613d-4208-8960-74f50e501de8	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c89be20a-edd1-40fa-be5d-6f7b7ce13188	736ec45e-fa79-4aa5-a901-2d1c31f70b76	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c93c60ca-8c56-4bb8-9ffc-3bab9f51d3bf	8b01a2e8-e683-4b0e-9487-284476cf5540	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c95770ea-24c7-4abf-b000-d933f6142f99	3ddb7e17-770e-4518-9cb2-84eb174d2832	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
c9eb4493-d2eb-4458-b6d3-95959b656f02	77391cc6-ae8b-4acd-979f-d6f9cd29304e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
caa39553-0a34-42fe-9823-ada85cb7e98b	1d7c96ea-e773-4153-a4e8-c584a6d69910	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
caac15f0-b02d-4b28-b2b9-d95879f3089f	f8ccca27-99eb-4cf7-888d-bba86c3d0865	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
caba9b56-61ed-4da3-a730-109e5f5bc241	6c23b6bd-7819-4668-ae2e-1dcf9b0aa805	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cb8f3528-2268-4de6-b8eb-d456f67ccb6f	71cf25c2-56b8-4d29-8e71-3265a322a74c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cc0bc69e-f57a-4b2c-9e75-e5933054f3db	51c899f8-ba85-4835-bade-c3b33b811a71	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cdacc79b-7f56-4f01-ae8d-006b0cf8e110	de09e696-940e-4e60-86ff-30bfe3a897ad	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cdf8a2f9-0212-464f-aa70-a7b39170067c	2b182c80-a6ad-474d-b49a-d6a63f55604f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cdf94443-9618-4753-b791-370e279b6687	3fc72bcf-99a9-4267-bc41-2437caa31a83	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ced6c6c9-677d-41e5-9af8-320fd43fd3eb	73f9fc2e-df41-4a8a-87eb-921b0f02d0d6	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cef1fe8d-adaf-48e0-8027-8f9163e14387	5e7fc7ef-f0cc-43b7-b118-44a148cd379e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cf23be3e-e600-4b3c-8f1f-2ef5235198b9	29b23b29-83f2-4654-925a-c7aafce5ab7b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cf443bd9-706d-4a02-b9be-d59458b0423a	44090892-2049-4558-be67-18e033ef9a96	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cf9c7464-2c3d-402e-95ed-de85b8b1b9f1	1e4e0e2b-6d6d-4160-b91c-22793c8b1668	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cf9e76cb-a8c1-438e-923b-f97e794f1314	716f7e14-156b-4604-a676-863ce0cdb593	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
cfc9f89d-7910-442a-9cd0-5c9f22c51dae	f378109a-73ef-479e-8efe-15e2a380adad	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
d0cd9587-f5a1-4149-8c22-20d28e82d475	9231558a-62b5-4a9d-a280-9216fe64b052	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
d12c4e7a-8b47-4415-b8f1-07087ea60f6e	8bb9cf70-bf63-4cbe-b65c-5ea0a41157f4	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
d1e4b82a-23d0-4145-bbf2-349516fe841f	764587b6-202c-4d20-8298-fc58d9f0a0b5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
d1f20eee-8230-4e1c-a81e-bd295ff13c95	7d3e353c-7b6f-4712-90c4-30e0c4d438ad	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
d3015e47-9244-4918-a3bd-8e4429e48d7c	f8d5ae04-b8af-4b6d-9ba4-dd84eebef78c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
d526b0af-d517-4b6a-95d6-472565ddae27	1b9ac7fa-0fd2-49f9-87e6-bee0f818cefd	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
d6c706f3-0940-47e0-98bd-7bef545e96b6	287bcf1f-7622-410f-8052-e64dfa4ed17e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
d7a33f6b-20ed-4b4a-a5a4-1569ffdf456f	66c26548-7216-4afe-80d0-44ef5aac825e	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
d7db3d91-fc48-4621-84ca-342b25aea0a0	61174faf-bd94-4fd1-b0d0-6759882416bc	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
d970a30d-eec5-419e-a74a-cbf195c41d90	26dcc773-62bd-438f-850f-e0a0ff5fcf8b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
dab85a0e-7eed-4123-be74-76437e14ca47	5c2114bf-d64f-406e-a24e-e5e01e2442dd	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
dac23289-ac0e-45cd-87f7-fd608b2b3b3e	e2a5d1e3-dbec-4442-9eb2-f520140628e0	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
daca457a-a2c6-4b66-b176-863ae9dd78c7	cb48fe05-39b7-432b-b5d5-943fe49e8083	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
dc31981d-ecd4-45bd-a6fe-d9acbf471684	01de2986-c6a5-4631-97b1-ffedf0752b03	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
dc5105d1-d2a7-4e7c-92eb-01e40d8f8cc4	66ea63f5-3d34-4c2a-9de6-3618a82b2bb9	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
dcc54d60-f192-48bf-924c-578c5b4359b7	acdb9840-62a1-4beb-a932-e82fa766c26f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
dcf08619-9353-4a63-9c94-fb842a7a12d0	a5bdba44-9ed7-4165-9d31-39ce5917add1	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ddf32f34-22a0-4616-ae9c-a00d3ab9a7ee	fc792b6b-1d92-474f-be2a-02724143e861	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
de7d3205-eff6-40b4-8e6f-ae565fe48393	4f0bc72e-5a02-4437-b70e-bffc19bcded6	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e0013cfd-61b9-4c84-b9e2-cda794a4a6fd	12296772-f6a6-4c8b-9ea2-81b718b305e1	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e05f1c10-4c59-406a-b849-286fe4f4f1cf	6b04f379-3623-4d2e-9ec1-23d352250c1a	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e1829e8f-1280-445b-b337-1a59502edec5	5cf23e1a-7b76-4966-b6c5-965fb4e2e3ea	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e1c126fd-84c8-4be6-b870-182073df0935	a1873476-920e-41ac-8036-dc82cf06a69f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e2b38817-2f69-43d3-8bd6-fa88116f305b	0306e30d-d939-4220-83c7-c0cbc3197e39	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e2ef9c7e-241c-4ed3-ad7d-01a1f9e160a9	83acc004-e8a1-48d3-a31b-2080790a7b25	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e2fbed42-9c27-4425-ae1b-e14c10b27dec	781ad4a9-03b1-4e91-9c9b-b474c52d47a5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e3578f68-da7b-49bc-b4d3-8c1daa15eff3	1c7d85dc-0745-4ea5-af1a-100249b4f3db	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e3927e31-1569-47b2-a5f7-b45b84274ea0	5994c332-b4f1-44bc-b108-62c09a08fdbe	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e3b49f0c-13d6-462b-984c-1dcbdb5e163a	274e46fd-8deb-4519-b37a-75efb71e087f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e4371558-2afb-4737-8f46-743db4609a25	fa02ed1e-c741-4940-abb0-3d2882f71392	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e48a2623-b151-4017-affb-dc9447bfcf85	d39278f6-e2c4-4ce0-bf5f-db9b198e5441	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e4ac51a5-dec7-4719-a925-c4731c78a008	68468e0b-ee66-4f1e-a6d8-865c835b11bd	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e4c864d1-b3fc-4326-b75b-36042fef5304	4a415d3e-747d-4450-8d77-f1d772a3b268	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e4e717e6-36f5-4c5c-9abe-1f817b4a3050	d3ec3646-af04-4a83-b451-49fab18cbcab	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e565752c-8877-4efc-985b-6c9535798f99	e6ad9e66-f65c-4516-8ba0-f45083b8fa07	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e6a0f7bc-b4e6-4a22-9a55-dd94dcdf2ee2	2fe0467e-75b0-440b-b258-65333bf99c25	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
e74f313d-9734-4133-8a91-5a4a64a89608	4c800036-3433-42c7-9b36-0d50684662e3	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ea7d12b6-4d22-4121-9abc-e93fb81aeb32	1e16ec3f-d62a-42e0-b5cf-762f2266d1eb	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ea8e8fc1-835f-4ed2-b8a9-3c25a3b12a9b	4caeb887-9fbb-44c2-8047-fa08230837d5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ea977d32-30c9-4409-813d-b7e76aa220de	d1ff77fa-ac5a-497a-aae0-81f9b6acacff	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
eaf78a42-5acc-45e3-baf5-182c7484a6b6	131fa31e-71e8-4917-a160-8f4c0a315589	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
eb6a29d3-4aec-4c7c-a5d5-1734a20e44be	46ab24f2-0725-4855-bd36-78a866ce42ec	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ebf89abd-fd2f-4138-b499-b05c4b971402	f90fa342-36e0-44ad-9efd-bc7fd6f471a5	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ec01c899-85a4-4ff8-a158-11c90d455024	0ce89b43-243a-4612-b427-f8a9e744cfcb	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ec51fe26-da59-45e3-86da-0d415539d637	f5413ad6-2619-4a51-8313-6996a3da1d00	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ec9c7349-4842-4252-b893-c8c8f6cf7197	d0ab2e1b-57a7-4fdc-a324-57954779d576	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ecf5779f-cac3-4a72-89b0-4f2b296d8642	622a742a-0808-4911-b327-e04f92f35677	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ed1d32c8-af0a-4829-8c84-f4ef83029d84	5ab509c9-0bc7-4150-b7a8-8f71c1d83712	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ed9037a8-a34c-46bd-9a9b-b70a87191fde	08f9606a-f132-4603-a759-e6d6add0e6cf	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ee6a57d6-679b-49d7-b53a-a8f8e07b3238	11bacde1-14fa-477f-8b91-f8d4236d97da	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
eed17f5a-29f5-4a5f-b937-25a74c85ddce	2533c33f-b76c-420b-8c9c-8eb43f5bd8db	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ef6316aa-8911-4fdd-988f-4221435a09e3	74253e2f-1df6-40db-9ecd-37a8e62bbcac	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
ef69cd68-9d31-403c-a66b-25baeea1d332	49cd67f8-ae9d-4785-a7ca-b156f9c2ed0d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
efb4350d-3033-4b34-82aa-60d7830fd775	df7554ff-f7fa-4824-a7a7-d0d9e2f52663	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f01848d7-f277-4bb7-9c30-945ee89b873d	2c132fa4-0b19-46d8-af93-ebafd0353493	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f0576aa1-b134-491a-b675-18e8093e1d34	a714a52f-a4e3-42ba-9c46-d557d8a2e662	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f05ad972-1fbd-416b-91e6-2616b29ee18e	11e0874d-bfdd-49db-b0c0-6ced141e9285	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f06e1f55-8d44-4869-9c41-9af745d41294	f446571c-cb01-438e-90a0-cfd8b895b06c	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f3ba7086-4e56-4407-b08d-c340feaab134	3029978c-9f96-47ce-93e6-f21228c7c968	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f5167e3d-87f9-43bf-b02a-80c5ffc09f4d	39f56347-1b51-4695-ac49-0de2ef32495d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f5318c88-d90f-49da-bbca-11c0ebfc051a	01828aa7-1afa-4580-9e36-5ca2300e67ee	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f53bed63-835b-45b7-9d48-c959c6552458	ae3a77ff-cd96-4598-8721-f5808ae4d40b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f63a6e07-22bc-4f16-8d1d-23126291dbe0	08876f1d-ac07-42c1-8a5e-5fbaea8447e6	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f69e3a3f-71cf-4707-896a-85b166fce479	9f678920-add5-4f08-b3aa-a9f3a88cb1f8	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f80667ef-ec7b-4386-9dc4-911bb601937e	4cc876b7-0360-4dee-ae29-32f8faef097f	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f85c47d5-f3d5-4fcc-bbd1-5011fcad815b	26b4e878-1c35-4aa1-a458-8c6adb4905ad	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
f8982d57-15b8-4138-9dc3-0cab94c40695	80b3478f-aab3-444a-9c1f-9625fa2ade60	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
fa4fd81f-458a-4003-aafe-1b588945d227	e46682fb-86ec-40e2-9126-1feb15debbe2	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
fa6aaaec-a131-46d6-af41-5d2a25a05833	534d0cfe-1f45-4b7a-b96f-2d69b2869f8b	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
fb485de1-59c6-4c0f-ab7e-b694254faf40	cbc5788d-9be6-469e-89c0-3eeaeb0fcb73	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
fc5cc58a-af5b-4573-85bc-36660145e409	412fc311-7975-41da-9c17-f6c384fcdbff	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
fce9c262-5163-4565-9fbc-dca7fa83056f	8bc0b407-c1c1-489e-8095-c72289030a6d	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
fd00d2ba-79a3-44c1-8b91-1a6baca148de	784f6911-2050-43d1-8093-6a24aa5bc059	https://www.youtube.com/embed/AZDSpS5v57w	\N	2026-06-11 09:40:17.44595+00	\N	f
\.
...
33277143-0e54-47ee-a5db-4b483538a3b0	2e868e31-a162-427b-a84a-cf7308595086	3600145f-dbec-412b-94f1-08942f6afa16	900000.0	\N	2026-06-11 09:40:17.44595+00	\N	f
3452f3c1-8338-4898-9e6f-0029abd4f807	0b75296c-7d54-46b8-a13d-e4a597ea1946	7e7c3458-5caa-43c3-84d7-383ac98097f1	0.0	\N	2026-06-11 09:40:17.44595+00	\N	f
3b169a60-aab3-4129-aa2c-1c8f1eabb4bb	8eff619b-8d1b-4b4e-8fc8-04d864619a11	3600145f-dbec-412b-94f1-08942f6afa16	900000.0	\N	2026-06-11 09:40:17.44595+00	\N	f
5dfd55e4-02fa-4f2e-a5fa-38244fb8d04b	0b75296c-7d54-46b8-a13d-e4a597ea1946	820b7ae8-fcf9-46f4-b206-36d3bc57a496	0.0	\N	2026-06-11 09:40:17.44595+00	\N	f
620da5b0-62f2-431d-bfba-e2f2424ff5a0	0b75296c-7d54-46b8-a13d-e4a597ea1946	3600145f-dbec-412b-94f1-08942f6afa16	900000.0	\N	2026-06-11 09:40:17.44595+00	\N	f
86bd401a-27bd-4a91-9e31-ce7a102afe42	2e868e31-a162-427b-a84a-cf7308595086	820b7ae8-fcf9-46f4-b206-36d3bc57a496	0.0	\N	2026-06-11 09:40:17.44595+00	\N	f
a98f8f0d-6274-40bb-9ee1-9955b4dd137d	2e868e31-a162-427b-a84a-cf7308595086	7e7c3458-5caa-43c3-84d7-383ac98097f1	0.0	\N	2026-06-11 09:40:17.44595+00	\N	f
a9c20941-2382-42ee-8210-a5db86695959	8eff619b-8d1b-4b4e-8fc8-04d864619a11	7e7c3458-5caa-43c3-84d7-383ac98097f1	0.0	\N	2026-06-11 09:40:17.44595+00	\N	f
fc42cb24-9f93-4687-bf8e-9b913474afd1	8eff619b-8d1b-4b4e-8fc8-04d864619a11	820b7ae8-fcf9-46f4-b206-36d3bc57a496	0.0	\N	2026-06-11 09:40:17.44595+00	\N	f
\.
...
0b75296c-7d54-46b8-a13d-e4a597ea1946	019ddd8c-f6e1-7511-94bd-0a10582186a3	900000.0	2	Đơn hàng mua khóa học	\N	2026-06-11 09:40:17.44595+00	\N	f
2e868e31-a162-427b-a84a-cf7308595086	019ddd8c-f773-7d46-9bf6-03a520cda5da	900000.0	2	Đơn hàng mua khóa học	\N	2026-06-11 09:40:17.44595+00	\N	f
8eff619b-8d1b-4b4e-8fc8-04d864619a11	019ddd8c-f65a-7ad2-a4fa-1a6f00d0d1cb	900000.0	2	Đơn hàng mua khóa học	\N	2026-06-11 09:40:17.44595+00	\N	f
\.
...
--
-- Data for Name: StudentPreferences; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."StudentPreferences" ("Id", "StudentId", "FavouriteCategories", "PreferredDifficulty", "LearningGoal", "MinutesPerDay", "SkillLevel", "RecommendContests", "RecommendExercises", "AutoRefresh", "CreationTime", "LastModificationTime", "UserId", "IsDeleted") FROM stdin;
\.


--
-- Data for Name: StudentSkillProfiles; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."StudentSkillProfiles" ("Id", "StudentId", "Category", "Difficulty", "TotalAttempts", "PassedAttempts", "AverageScore", "AverageRuntime", "MasteryScore", "IsWeakArea", "LastAttemptedAt", "CreationTime", "LastModificationTime", "UserId", "IsDeleted") FROM stdin;
\.
...
9f749847-d490-4b4c-95b3-8e877263d8e4	019ddd8c-f65a-7ad2-a4fa-1a6f00d0d1cb	f8d5ae04-b8af-4b6d-9ba4-dd84eebef78c	t	\N	2026-07-08 11:54:01.01575+00	\N	f	100
\.


--
-- Data for Name: UserRecommendations; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."UserRecommendations" ("Id", "UserId", "CourseId", "Score", "Rank", "GeneratedAt", "CreationTime", "LastModificationTime", "IsDeleted") FROM stdin;
\.
...
20260610165757_AddContestPrizesTable	10.0.5
20260610173043_AddPrizeRangeColumns	10.0.5
20260610174112_AddIsApprovedToUser	10.0.5
20260704101250_AddRecommentAndChatTables	10.0.5
20260708113720_AddRecommendTables	10.0.5
\.
...
SELECT pg_catalog.setval('hangfire.jobparameter_id_seq', 5, true);
...
--
-- Name: ChatConversations PK_ChatConversations; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ChatConversations"
    ADD CONSTRAINT "PK_ChatConversations" PRIMARY KEY ("Id");
...
--
-- Name: ContestPrizes PK_ContestPrizes; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ContestPrizes"
    ADD CONSTRAINT "PK_ContestPrizes" PRIMARY KEY ("Id");
...
--
-- Name: CourseCoOccurrences PK_CourseCoOccurrences; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CourseCoOccurrences"
    ADD CONSTRAINT "PK_CourseCoOccurrences" PRIMARY KEY ("Id");


--
-- Name: CourseEmbeddings PK_CourseEmbeddings; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CourseEmbeddings"
    ADD CONSTRAINT "PK_CourseEmbeddings" PRIMARY KEY ("Id");


--
-- Name: CourseSimilarities PK_CourseSimilarities; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CourseSimilarities"
    ADD CONSTRAINT "PK_CourseSimilarities" PRIMARY KEY ("Id");
...
--
-- Name: StudentPreferences PK_StudentPreferences; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."StudentPreferences"
    ADD CONSTRAINT "PK_StudentPreferences" PRIMARY KEY ("Id");


--
-- Name: StudentSkillProfiles PK_StudentSkillProfiles; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."StudentSkillProfiles"
    ADD CONSTRAINT "PK_StudentSkillProfiles" PRIMARY KEY ("Id");
...
--
-- Name: UserRecommendations PK_UserRecommendations; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."UserRecommendations"
    ADD CONSTRAINT "PK_UserRecommendations" PRIMARY KEY ("Id");
...
--
-- Name: IX_ChatConversations_UserId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_ChatConversations_UserId" ON public."ChatConversations" USING btree ("UserId");


--
-- Name: IX_ChatMessages_ConversationId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_ChatMessages_ConversationId" ON public."ChatMessages" USING btree ("ConversationId");
...
--
-- Name: IX_CourseCoOccurrences_CoCourseId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_CourseCoOccurrences_CoCourseId" ON public."CourseCoOccurrences" USING btree ("CoCourseId");


--
-- Name: IX_CourseCoOccurrences_CourseId_Weight; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_CourseCoOccurrences_CourseId_Weight" ON public."CourseCoOccurrences" USING btree ("CourseId", "Weight");


--
-- Name: IX_CourseEmbeddings_CourseId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "IX_CourseEmbeddings_CourseId" ON public."CourseEmbeddings" USING btree ("CourseId");


--
-- Name: IX_CourseSimilarities_CourseId_Score; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_CourseSimilarities_CourseId_Score" ON public."CourseSimilarities" USING btree ("CourseId", "Score");


--
-- Name: IX_CourseSimilarities_SimilarCourseId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_CourseSimilarities_SimilarCourseId" ON public."CourseSimilarities" USING btree ("SimilarCourseId");
...
--
-- Name: IX_StudentPreferences_StudentId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "IX_StudentPreferences_StudentId" ON public."StudentPreferences" USING btree ("StudentId");


--
-- Name: IX_StudentSkillProfiles_StudentId_Category_Difficulty; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "IX_StudentSkillProfiles_StudentId_Category_Difficulty" ON public."StudentSkillProfiles" USING btree ("StudentId", "Category", "Difficulty");
...
--
-- Name: IX_UserRecommendations_CourseId; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_UserRecommendations_CourseId" ON public."UserRecommendations" USING btree ("CourseId");


--
-- Name: IX_UserRecommendations_UserId_Rank; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "IX_UserRecommendations_UserId_Rank" ON public."UserRecommendations" USING btree ("UserId", "Rank");
...
--
-- Name: ChatConversations FK_ChatConversations_AspNetUsers_UserId; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ChatConversations"
    ADD CONSTRAINT "FK_ChatConversations_AspNetUsers_UserId" FOREIGN KEY ("UserId") REFERENCES public."AspNetUsers"("Id") ON DELETE CASCADE;


--
-- Name: ChatMessages FK_ChatMessages_ChatConversations_ConversationId; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ChatMessages"
    ADD CONSTRAINT "FK_ChatMessages_ChatConversations_ConversationId" FOREIGN KEY ("ConversationId") REFERENCES public."ChatConversations"("Id") ON DELETE CASCADE;
...
--
-- Name: CourseCoOccurrences FK_CourseCoOccurrences_Courses_CoCourseId; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CourseCoOccurrences"
    ADD CONSTRAINT "FK_CourseCoOccurrences_Courses_CoCourseId" FOREIGN KEY ("CoCourseId") REFERENCES public."Courses"("Id") ON DELETE CASCADE;


--
-- Name: CourseCoOccurrences FK_CourseCoOccurrences_Courses_CourseId; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CourseCoOccurrences"
    ADD CONSTRAINT "FK_CourseCoOccurrences_Courses_CourseId" FOREIGN KEY ("CourseId") REFERENCES public."Courses"("Id") ON DELETE CASCADE;


--
-- Name: CourseEmbeddings FK_CourseEmbeddings_Courses_CourseId; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CourseEmbeddings"
    ADD CONSTRAINT "FK_CourseEmbeddings_Courses_CourseId" FOREIGN KEY ("CourseId") REFERENCES public."Courses"("Id") ON DELETE CASCADE;


--
-- Name: CourseSimilarities FK_CourseSimilarities_Courses_CourseId; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CourseSimilarities"
    ADD CONSTRAINT "FK_CourseSimilarities_Courses_CourseId" FOREIGN KEY ("CourseId") REFERENCES public."Courses"("Id") ON DELETE CASCADE;


--
-- Name: CourseSimilarities FK_CourseSimilarities_Courses_SimilarCourseId; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CourseSimilarities"
    ADD CONSTRAINT "FK_CourseSimilarities_Courses_SimilarCourseId" FOREIGN KEY ("SimilarCourseId") REFERENCES public."Courses"("Id") ON DELETE CASCADE;
...
--
-- Name: UserRecommendations FK_UserRecommendations_AspNetUsers_UserId; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."UserRecommendations"
    ADD CONSTRAINT "FK_UserRecommendations_AspNetUsers_UserId" FOREIGN KEY ("UserId") REFERENCES public."AspNetUsers"("Id") ON DELETE CASCADE;


--
-- Name: UserRecommendations FK_UserRecommendations_Courses_CourseId; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."UserRecommendations"
    ADD CONSTRAINT "FK_UserRecommendations_Courses_CourseId" FOREIGN KEY ("CourseId") REFERENCES public."Courses"("Id") ON DELETE CASCADE;
...
\unrestrict arXUO04lDkOlnkBUmT1nDXqDyVHpvk6G77EqtTmbLg5xA0BlWPe5l9wRUj36tHX
