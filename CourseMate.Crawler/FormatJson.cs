using CourseMate.Crawler.Models.Categories;
using CourseMate.Crawler.Models.Chapters;
using CourseMate.Crawler.Models.Courses;
using CourseMate.Crawler.Models.Lessons;
using CourseMate.Crawler.Response.ActivityResponse;
using CourseMate.Crawler.Response.CategoryResponse;
using CourseMate.Crawler.Response.CourseDetailResponse;
using CourseMate.Crawler.Response.CourseListReponse;
using Newtonsoft.Json;
using Activity = CourseMate.Crawler.Response.CourseDetailResponse.Activity;
using Datum = CourseMate.Crawler.Response.CategoryResponse.Datum;

namespace CourseMate.Crawler;
